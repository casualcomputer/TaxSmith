---
title: "Place of Supply in a Province – Overview"
...
GST/HST Memorandum 3-3-2 April 2026

This version replaces the one dated August 2024. This memorandum has been updated to reflect the HST rate change in Nova Scotia, as well as for consistency with the rest of the place of supply memoranda series. It also cancels and replaces Draft GST/HST Technical Information Bulletin B-103, *Harmonized Sales Tax – Place of supply rules for determining whether a supply is made in a province*.
...
- [General](#h_1)
    ...
    - [Application of the GST or the HST](#h_1_1)

    - [Deemed supplies](#h_1_2)

          - [Deemed supplies of property](#h_1_2_1)

          - [Supplies deemed to be made in a province](#h_1_2_2)

    - [Self-assessment](#h_1_3)

    - [Rebates](#h_1_4)

- [Factors to consider before applying the place of supply rules](#h_2)

    - [Factor 1 – Single and multiple supplies](#h_2_1)

          - [Conducting a single or multiple supply analysis](#h_2_1_1)

          - [Incidental supplies](#h_2_1_2)

    - [Factor 2 – Characterization of supplies](#h_2_2)

          - [Definitions and terms](#h_2_2_1)

          - [Intangible personal property versus a service](#h_2_2_2)

          - [Specific types of supplies](#h_2_2_3)

    - [Factor 3 – Place of supply rules for inside or outside Canada](#h_2_3)

    - [Factor 4 – Tax status of supplies](#h_2_4)

- [First Nations goods and services tax – place of supply](#h_3)

    - [Supply is deemed to be made on FNGST lands in a non-participating province](#h_3_1)

    - [Supply is deemed to be made on FNGST lands in a participating province](#h_3_2)

    - [Supply is deemed to be made in Canada, but not on FNGST lands](#h_3_3)
...
9. Listed below are the current GST/HST rates for each province. For the list of all applicable GST/HST rates (current and historic), go to [GST/HST calculator (and rates)](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/gst-hst-businesses/charge-collect-which-rate/calculator.html).
...
- A supply made in Canada is deemed to be made in a province under section 144.1 if it is deemed to be made in the province under the place of supply rules in Schedule IX but is deemed to be made outside the province in any other case. Further, a supply that is made in Canada that is not made in any participating province is deemed to be made in a non-participating province.

- Schedule IX contains a number of place of supply rules for specific types of supplies. However, provisions under Part IX of Schedule IX override the other place of supply rules in Schedule IX. Pursuant to section 3 of Part IX of Schedule IX, a supply made in Canada is made in a province if it is prescribed to be made in the province by Part 1 of the *New Harmonized Value-added Tax System Regulations*.

- In addition, Part IX of Schedule IX sets out a number of rules that override the provincial place of supply rules in Schedule IX in circumstances where supplies are deemed to be made pursuant to various provisions of Part IX of the ETA, as outlined in paragraphs 12 and 13 of this memorandum.
...
- 129 – small supplier division of a public service body

- 129.1 – supply by small supplier division

- 171 – becoming and ceasing to be a registrant

- 171.1 – taxi businesses

- 172 – appropriation of property

- 183(1) – seizure and repossession

- 183(4) – use of real property seized by creditor

- 184(1) – supply to insurer on settlement of claim

- 184(3) – use of real property transferred to insurer

- 196.1 – appropriation for use as capital property

- 268 – inter vivos trusts
...
- Subsection 163(2.1) which deems the provincially taxable portion of a tour package in respect of a participating province to be a supply made in that province (for more information, refer to [GST/HST Memorandum 27-1, Calculating the GST/HST on Tour Packages](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/27-1.html)).

- Subsection 178.8(4) which applies where a specified supply of imported goods is made outside Canada and the supplier and recipient of the goods enter into an agreement to have the supplier, rather than the recipient, be the person entitled to an input tax credit for the tax on the importation of the goods (for more information, refer to [GST/HST Policy Statement P-125R, Input Tax Credit Entitlement for Tax on Imported Goods](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/p-125.html)).

- Subsection 179(1) which provides that in the case of a drop shipment, the supply of tangible personal property made to a non-resident person who is not registered is deemed to be made in the participating province where the physical possession of the tangible personal property is transferred (for more information, refer to [GST/HST Memorandum 3-3-1, Drop-Shipments](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/3-3-1.html)).
...
- Part 5 of the *New Harmonized Value-added Tax System Regulations, No. 2*, Property and Services Brought into a Province

15. For further information on self-assessment of the provincial part of the HST, refer to [GST/HST NOTICE266 - Draft GST/HST Technical Information Bulletin, Harmonized Sales Tax – Self-assessment of the provincial part of the HST in respect of property and services brought into a participating province](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/notice266.html).
...
- determine if there is a single supply or if there are multiple supplies being made

- characterize the nature of the supply or supplies

- determine if the supply or supplies are made inside or outside of Canada

- determine the tax status of the supply or supplies
...
- whether the property or services are provided by two or more suppliers

- whether there is more than one recipient

- what the supplier is providing for the consideration received

- whether the recipient is made aware of the elements (in detail) that are part of the transaction
...
28. For further information regarding single or multiple supplies, refer to [GST/HST Policy Statement P-077R2, Single and Multiple Supplies](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/p-077r2.html).
...
- the nature of the agreement between the supplier and the recipient

- whether the agreement is in substance for work (or work and materials), or for property (including a right or interest of any kind)
...
- repairs, maintenance, cleaning, adjustments, or alterations to tangible personal property that the supplier has received from the recipient
...
55. Different place of supply rules determine whether a supply is made in or outside Canada for purposes of determining whether the GST or the federal part of the HST applies to the supply. These rules, which are also based on the nature of the supply that is made, are explained in [GST/HST Memorandum 3-3, Place of Supply](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/3-3.html).

56. In some cases, supplies made to non-registered non-residents involving drop shipments may be deemed to be made outside Canada as explained in [GST/HST Memorandum 3-3-1](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/3-3-1.html).

57. In other cases, a supply of personal property or a service (other than a qualifying tangible personal property supply as defined in subsection 211.1(1) made by a person required to be registered under section 211.22) made in Canada by a non-resident who is not registered and is not carrying on business in Canada, may be deemed to be made outside Canada. Whether a non-resident is carrying on business in Canada for GST/HST purposes is a question of fact requiring consideration of all relevant circumstances. The factors that the CRA considers in determining whether a non-resident person is carrying on business in Canada for GST/HST purposes are set out in [GST/HST Policy Statement P-051R2, Carrying on business in Canada](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/p-051r2.html).

58. For further information regarding the requirement to register for a person making or facilitating qualifying tangible personal property supplies, go to [GST/HST for digital economy businesses - Supply of qualifying goods threshold amounts](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/gst-hst-businesses/digital-economy-gsthst/find-out-need-register/sales-goods-threshold-amounts.html).
...
67. Provided the purchaser meets the criteria set out in [GST/HST Technical Information Bulletin B-039, GST/HST Administrative Policy – Application of the GST/HST to Indians](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/b-039.html), the provincial part of the HST would be relieved. Where the purchaser does not qualify for relief of the provincial part of the HST under Technical Information Bulletin B-039, registered vendors are required to collect the provincial part of the HST in participating provinces unless relief of that part is provided by some other legislation or policy.
