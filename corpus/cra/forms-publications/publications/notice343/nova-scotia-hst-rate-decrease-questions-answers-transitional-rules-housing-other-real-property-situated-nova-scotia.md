---
title: "Nova Scotia HST Rate Decrease – Questions and Answers on Transitional Rules for Housing and Other Real Property Situated in Nova Scotia"
source: https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/notice343/nova-scotia-hst-rate-decrease-questions-answers-transitional-rules-housing-other-real-property-situated-nova-scotia.html
...
GST/HST Notices - Notice 343 March 2025
...
This notice includes questions and answers that reflect the application of the transitional rules to supplies of real property. For other types of transactions, refer to [GST/HST Notice 342, Nova Scotia HST Rate Decrease – Questions and Answers on General Transitional Rules for Personal Property and Services](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/notice342.html).
...
- [Residential real property](#toc0)

    - [Application of the HST to the sale of new or substantially renovated housing](#toc1)

    - [Application of the HST to owner-built new or substantially renovated rental housing](#toc2)

    - [Additional questions](#toc3)

- [Non-residential real property](#toc4)

    - [Sales of non-residential real property](#toc5)

    - [Leases of non-residential real property](#toc6)

- [Progress payments](#toc7)
...
- make a supply by way of lease of the complex or condominium unit for use by an individual as a place of residence

- in the case of a multiple unit residential complex or addition thereto, make a supply by way of lease of a unit in the complex or addition for use by an individual as a place of residence
...
For more information on the self-supply of rental housing, refer to [Guide RC4052, GST/HST Information for the Home Construction Industry](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/rc4052.html).
...
- the day the supplier first issues an invoice for the consideration or part

- the date of that invoice

- if there is an undue delay in issuing that invoice, the day the supplier would have issued the invoice
...
Refer to [Guide RC4052](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/rc4052.html) for more information on progress payments.
...
- the day the purchaser pays the contractor the amount of the holdback

- the day the holdback is payable under the written agreement or applicable legislation
...
Refer to [Guide RC4052](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/rc4052.html) for more information on holdbacks.
...
Refer to [Guide RC4052](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/rc4052.html) for more information on deposits.
