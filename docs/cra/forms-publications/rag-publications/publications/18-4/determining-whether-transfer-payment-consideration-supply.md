---
title: "Determining Whether a Transfer Payment is Consideration For a Supply"
source: https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/18-4/determining-whether-transfer-payment-consideration-supply.html
last_modified: 2022-09-07
---
# Determining Whether a Transfer Payment is Consideration For a Supply

GST/HST Memorandum 18-4 June 2022
...
- [Meaning of significant terms](#_Toc103858790)

- [Overview](#_Toc103858791)

- [Direct link between the transfer payment and the supply](#_Toc103858792)

    - [Terms of an agreement that may indicate a direct link](#_Toc103858793)

- [Nature and mandate of the grantor](#_Toc103858794)

    - [Public sector body or funding organization](#_Toc103858795)

    - [Private-sector commercial business](#_Toc103858796)

    - [Mandate to oversee or fund public programs](#_Toc103858797)

    - [Grantor’s mandate to provide property or service](#_Toc103858798)

- [Purpose of a transfer payment](#_Toc103858799)

    - [To financially support an activity](#_Toc103858800)

          - [Indicators that a transfer payment is to financially support an activity](#_Toc103858801)

    - [To acquire property or services](#_Toc103858802)

          - [Contracting out](#_Toc103858803)

          - [Indicators of an input to the grantor’s activities/contracting out](#_Toc103858804)

- [Accountability measures and measures that are ancillary to the main purpose of the transfer payment](#_Toc103858805)

    - [Measures undertaken for accountability purposes](#_Toc103858806)

    - [Measures that are ancillary to the main purpose of the transfer payment](#_Toc103858807)

- [Summary of indicators to determine the existence of a direct link](#_Toc103858808)

- [Transfer payments passing through intermediaries](#_Toc103858809)
...
12. There may be cases where a transaction between a grantor and a grantee consists of several elements. Refer to [GST/HST Policy Statement P-077R2, Single and Multiple Supplies](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/p-077r2.html), for guidance on determining whether a transaction consisting of several elements is a single supply or two or more supplies.
...
- a grantee provides a grantor with the exclusive right to use the material produced as a result of the receipt of the transfer payment

- a grantee agrees that a grantor controls the release of the material produced as a result of receiving the transfer payment (for example, the right to decide to whom a research report is released)

- a grantee agrees to pay a grantor a certain portion or percentage of the income generated from the use of the transfer payment and this payment is not limited to the amount of the original transfer payment

- a grantee agrees to provide a grantor with the exclusive rights to publish, distribute and/or publicize the results produced from the receipt of the transfer payment

- a grantee agrees to provide a grantor with rights to intellectual property (for example, copyrights in respect of project results generated from the receipt of the transfer payment)
...
- the transfer payment is provided from a grantor’s funding program

- the transfer payment may be available to any person who qualifies (that is, who meets the eligibility criteria) under a particular funding program

- a grantor attaches limited conditions to the provision of the funding (for example, the conditions are accountability measures only or are ancillary to the main purpose of the funding)

- the transfer payment is provided as funding to support a person’s activities that are in the public interest

- a grantee applies for the funding from a grantor

- where the funding is used by a grantee to provide a service (for example, training) to a third party, it is the grantee that has control over the provision of the service (for example, the grantee decides who is eligible to receive the service, enters into any agreement with an eligible person for the provision of the service, issues any receipts for the service to participants and is the participants’ contact for any administrative issues) and the third party is not a specified third party
...
- the grantor is engaged in activities of a commercial nature

- the grantee provides property or a service to the grantor or a specified third party in exchange for the transfer payment

- the grantor is contracting out an activity that it is required (obligated) to undertake itself under legislation, by-law or contract

- the grantor selects the grantee through a tendering process initiated by the grantor
...
- the grantor has an obligation (for example, in legislation) to make the property available or render the services for which it is providing the transfer payment

- the grantor puts out a tender through a formal tendering process and provides the transfer payment to the successful bidder

- the grantee is required to post a performance bond or pay a penalty for non-performance of the terms of an agreement in respect of the provision of property or a service

- in the case where property is made available or a service is rendered to a third party by a grantee (for example, training), it is the grantor that controls the provision of that property or service (for example, the grantor decides/specifies who is eligible to receive the service, enters into any agreement with the eligible person, issues any receipts for the service and/or is the person’s contact point for any administrative issues regarding the service)
...
- A grantee agrees to provide to a grantor reports on the efforts expended in respect of a transfer payment. This may be a statement or indication that the money was spent as agreed upon. This could take the form of financial reports or a detailed written report accounting for the use of the transfer payment.

- A grantor requires a grantee to submit to an audit in respect of the use of a transfer payment when the grantor deems it necessary.

- A grantee agrees to acknowledge the provision of a transfer payment by a grantor in all public communications (for example, press releases and media announcements).
...
- A grantee agrees to repay a transfer payment to a grantor under certain conditions (for example, when the grantee’s product, produced as a result of the receipt of the transfer payment, is sold). The repayment may never occur. It will only be triggered if the condition is met.

- A grantee agrees to repay a transfer payment to a grantor if the grantee is unable to fulfill the terms of the transfer payment agreement. The repayment may never occur. It will only be triggered if the condition is met.
...
| Nature and mandate of the grantor | the grantor oversees or funds programs for the interest of the general public or a segment thereof | the grantor is engaged in commercial activities the grantor is contractually or legislatively required to provide a supply of property or services |

| Purpose of the transfer payment | the transfer payment is used to fund or subsidize the grantee’s activities that benefit the general public or a segment thereof the transfer payment is provided to the grantee as a result of a call request by the grantor for proposals/applications for funding the provision of funding is discretionary the transfer payment is available to persons who qualify (that is, who meet eligibility criteria set by the grantor) under a particular program the grantor may fund property made available or services rendered by the grantee to a person that is not a specified third party but is not obligated (under legislation or otherwise) to provide it the grantee agrees to pay the grantor a certain portion or percentage of the income generated from the use of the transfer payment but this payment will not exceed the amount of the original transfer payment where the grantee renders services to third parties, the grantee selects eligible third parties, enters into agreement with them, issues receipts to them or communicates with them on service issues the grantee provides the grantor with financial statements or reports on the use of transfer payment for accountability purposes only | the transfer payment is used to acquire property or services for the grantor’s or specified third party’s use, or as an input to the grantor’s own activities (that is, contracting out the grantor’s obligations) the transfer payment is provided as a result of tendering process the grantee posts performance bond or pays penalty for non-performance the government grantor retains ultimate legislative responsibility or obligation to provide property or services the grantee agrees to pay the grantor a certain portion or percentage of the income generated from the use of the transfer payment and this payment is not limited to the amount of the original transfer payment the grantor may receive exclusive right to material produced by the grantee or exclusive rights to copyrights or other intellectual property rights where the grantee renders services to third parties, the grantor selects eligible third parties, enters into an agreement with them, issues receipts to them or communicates with them on service issues the grantor controls the grantee’s release of information resulting from the use of the transfer payment |
...
- in providing the transfer payment, the intermediary has a funding purpose consistent with that of the original grantor

- although a transfer payment was provided by the original grantor to a single grantee (that is, the intermediary), the grantor acknowledged under the terms of the agreement with the intermediary that the funding could be passed on by the intermediary to other grantees that are involved in supporting the intermediary in carrying out the funded activities

- it is clear from the original agreement that the original grantor intended that the transfer payment be shared by several grantees, which may include the intermediary
