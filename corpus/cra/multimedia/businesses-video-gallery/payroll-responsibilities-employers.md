---
title: "Payroll Responsibilities for Employers"
gallery_title: "Payroll Responsibilities for Employers"
source: https://www.canada.ca/en/revenue-agency/news/cra-multimedia-library/businesses-video-gallery/payroll-responsibilities-employers.html
video_source: https://www.youtube.com/watch?v=9nyMSX_Kj2Q
...
- Tools for calculating types of pay
- and withholdings
- Books and Records
- Remitting
- Reporting
...
- CPP contributions
- additional CPP contributions (CPP2).
- EI premiums,
- and income tax from an employee's taxable, pensionable, and insurable income.
...
- The person's Social Insurance Number begins with 9
- The Social Insurance Number has not expired
...
- used however the employee chooses.
...
- CPP/QPP and second additional CPP/QPP maximum annual contributions have been reached
- CPP/QPP exempt
- Year-to-date amount from your records
For EI, select only one of the following options:
- EI maximum annual premium has been reached
- EI exempt
- Year-to-date amount
...
- whether written or in any other form
- receipts (original or copies)
- your employees’ identification documents
- such as their driver's
...
- information slips issued (for example, T4 slips) and returns filed
