---
title: "Webinar – Rules for charities making grants to grantees (non-qualified donees)"
gallery_title: "Rules for charities making grants to grantees (non-qualified donees)"
source: https://www.canada.ca/en/revenue-agency/news/cra-multimedia-library/charities-video-gallery/webinar-rules-charities-making-grants-grantees-non-qualified-donees.html
video_source: https://www.youtube.com/watch?v=DqDYwewmrlM
...
- First, we’ll take a brief look at the background behind working with non-qualified donees.
- Second, we’ll go into the CRA’s development of the granting guidance and some key points.
- Third, we’ll cover some special topics that relate to granting.
- And finally, we’ll provide you with a few resources.
...
- The term **“qualified donees”** is a term from the *Income Tax Act*, and it refers to organizations that can issue official donation receipts for gifts they receive from individuals and corporations.Canadian charities are probably the best-known category of qualified donee, but there are a few other types of organizations as well.
- The term **“non-qualified donees”** refers to those that **do not meet** the definition of a qualified donee.Intermediaries and grantees are both types of non-qualified donees. We will talk more about these in a moment.
...
1. First, by carrying on its own charitable activities through its staff and volunteers, or through a non-qualified donee called an “intermediary”.This meant that if a charity wanted to work with a non-qualified donee it could only do this if it exercised what is called “direction and control” over the intermediary, as though it is the charity’s own activity. There was long-standing criticism of direction and control in the charitable sector, with commenters saying it forced Canadian charities to micro-manage their international partners, for example, and hindered collaborative working relationships.
2. The second way a charity could operate is by making gifts to qualified donees, which is a relatively simple process under the *Income Tax Act*.As the name “gift” implies in this context, a charity can simply transfer money or other resources to another qualified donee without needing to monitor or follow up on how that gift is used.
...
- However, now charities can make transfers to non-qualified donees without maintaining direction and control over the use of the charity’s money or other resources.
...
For granting
- Charity must meet accountability requirements
- Reported as “qualifying disbursement”
- Charity can support existing work of non‑qualified done
- Accountability tools focus on:mitigating risk collaboration providing autonomy to non-qualified done
On the other hand, for direction and control
- Charity must exercise direction and control
- Reported as the charity’s “own activity”
- Activity must be the charity’s own caved-out initiative
- Measures focus on the charity directing and controlling the activities, such that they could be considered the charity’s own
...
[CG-032, Registered charities making grants to non-qualified donees](https://www.canada.ca/en/revenue-agency/services/charities-giving/charities/policies-guidance/charities-making-grants-non-qualified-donees.html)
...
- **149.1 (1) qualifying disbursement**means a disbursement by a charity, by way of a gift or by otherwise making resources available,
- **(paragraph a)** … to a qualified donee, or
- **(paragraph b)** to a grantee organization, if**(i) [subparagraph 1]** the disbursement is in furtherance of a charitable purpose (determined without reference to the definition charitable purposes in [subsection 149.1(1) of the *Income Tax Act*]) of the charity, **(ii) [subparagraph 2]** the charity ensures that the disbursement is exclusively applied to charitable activities in furtherance of a charitable purpose of the charity, and **(iii) [subparagraph 3]** the charity maintains documentation sufficient to demonstrate**(clause A)** the purpose for which the disbursement is made, and **(clause B)** that the disbursement is exclusively applied by the grantee organization to charitable activities in furtherance of a charitable purpose of the charity…
...
- Research and review the grantee before entering into the grant
- Collaborate with the grantee to develop a description of the grant activity
- Create a written agreement to document the grant activity, including the charitable purpose it furthers
- Establish a reporting plan, including a final report documenting how the charity used the grant resources
- Create a transfer schedule, if suitable (as in, send the grant in periodic instalments)
- And ask the grantee to separately track the grant resources, such as with a separate ledger – and just a note that this is not the same as accessing the grantee’s books and records.
...
#### Charitable purposes:
- Charities can only make grants that further the charity’s stated charitable purposes (the purposes in its governing documents, such as its articles of incorporation).
- Many charities will be able to expand their operations to include making grants to grantees using their existing purposes.
- However, a charity would need to amend its purposes if it:wants to make a grant for a purpose that is not stated in its governing document does not have a stated common law charitable purpose within one of the four categories of charity. This includes a foundation that only has a purpose to make gifts to other qualified donees
### Slide 20 – High-level takeaways of granting guidance (4/5)
Dylan:
- A charity could not make a grant with only a “making qualifying disbursements” or “making grants” purpose. A “grant-making” purpose in and of itself would not fall within one of the four categories of charity.
- When drafting a charitable purpose, it is not necessary for the charity to specify that the organization will be making grants.
- Here is an example of a purpose that would be suitable for a grant that advances education:To advance education by providing books, equipment, and educational aids to students.
- Here is an example of a purpose that would be suitable for a grant that relieves poverty:To relieve poverty by providing necessities of life, including food, clean water, medical supplies, clothing, or shelter to victims of disasters.
...
We’ve updated the [T3010, the Registered Charity Information Return](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t3010.html), the [related Guide](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/t4033.html), and created a new worksheet for reporting grants.
...
- For the due diligence review, we recommend the charity review the recipient grantee, but also the other grantors that it is establishing this relationship with.
- For the description of the grant activity, we recommend the charity document its involvement in the pooled funding, including the resources granted.
- For grant documentation, ideally, the charity would sign onto a grant agreement with all parties in the pooled funding, though we recognize that may not be feasible.
- For the reporting plan, we understand that pooled grants are complex. So we recommend a charity show it has made reasonable efforts to keep track of the grant activity. We also recommend a charity only enter into this type of arrangement when the grantee agrees to provide written final or interim reports. This can be a report to all grantors, not just the specific charity.
- We also recommend the charity contribute to the pooled grant on a periodic basis, particularly when the grant is high risk.
- And for separately tracked funds, ideally the grantee would separately track the charity’s contribution to the pooled grant. Depending on the pooled grant, we recognize this may not always be feasible, so in that case, we recommend the charity maintains records of its own contributions to the pooled grant.
...
- Understanding how terrorists can abuse your charity’s good work;
- Identifying risks that relate to your specific charity; and
- Taking steps to reduce your charity’s risks.
We encourage you to visit our [web pages](https://www.canada.ca/en/revenue-agency/services/charities-giving/charities/educating-charities-terrorist-abuse/checklist-protect-charity-against-terrorist.html) for more information.
...
- A charity carrying on its own activities through its own staff or volunteers
- A charity carrying on its own activities through an intermediary if it exercises direction and control
- A charity accepting a donor’s gift for a grant when the donor indicates a program preference (as opposed to specifying a non-qualified donee)
- A charity that can show that it retains authority over the use of its resources.
...
If you would like to receive recent news and updates from the CRA, we recommend you sign up for our electronic mailing list at [canada.ca/charities-whats-new](https://www.canada.ca/en/revenue-agency/news/e-services/canada-revenue-electronic-mailing-lists/electronic-mailing-list-charities-giving-whats-new.html).
Thank you.
#### Link summary on slide:
[Charities and giving](https://www.canada.ca/en/services/taxes/charities.html)
Feedback or suggestions about the granting guidance, email [guidancefeedback-retroactionsurleslignesdirectrices@cra-arc.gc.ca](mailto:guidancefeedback-retroactionsurleslignesdirectrices@cra-arc.gc.ca)
