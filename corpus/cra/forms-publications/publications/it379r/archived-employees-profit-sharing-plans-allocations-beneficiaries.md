---
title: "ARCHIVED - Employees Profit Sharing Plans -- Allocations to Beneficiaries"
source: https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it379r/archived-employees-profit-sharing-plans-allocations-beneficiaries.html
...
SUBJECT: INCOME TAX ACT**Employees Profit Sharing Plans -- Allocations to Beneficiaries**
...
- This is an HTML version of the printed publication. It is also available in [other formats](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it379r.html), including PDF (which is an exact rendition of the printed publication).

## Contents

- *[Application](#P75_2867)*

- *[Summary](#P79_3339)*

- *[Discussion and Interpretation](#P83_4506)*

    - [General](#P84_4535) (¶ 1)

    - [Determination of Trust Profits](#P91_5532) (¶s 2-3)

    - [Allocation of Capital Gains and Capital Losses](#P103_7728) (¶s 4-6)

    - [Allocation of Taxable Dividends](#P111_10940) (¶ 7)

    - [Allocation of Foreign Non-Business Income and Related Foreign Tax](#P113_11344) (¶ 8)

    - [Taxability of Amounts Allocated](#P115_11996) (¶ 9)

    - [Distributions to Beneficiaries](#P121_13018) (¶s 10-11)

    - [Distribution of Property Other Than Money](#P131_14464) (¶s 12-14)

    - [Withholding Requirements](#P154_19138) (¶ 15)

    - [Contingent Allocations and Forfeited Amounts](#P156_19607) (¶s 16-18)

    - [Non-Resident Beneficiaries](#P161_21283) (¶ 19)

- *[Appendix](#P169_22398)*

- *[Explanation of Changes](#P305_24224)*
...
- in existence before 1972 and for which an election under subsection 144(4.1) was made (see below), or
...
- Their employer contributed $400 out of profits to the trustee.

- The trustee allocated $200 to each of the two beneficiaries, and the beneficiaries included this amount in income in the year of allocation.

- The trustee purchased the following three properties:
...
- The trustee distributed the following assets to the two beneficiaries:

1st beneficiary -- property A and $50 in cash

2nd beneficiary -- property B and property C

- Neither beneficiary filed an election, under paragraph 110.6(19)(*c*), to report a capital gain on their interests in the EPSP at the end of February 22, 1994.
...
New [¶ 1](#P85_4542) has been added to briefly describe an EPSP and to explain what allocations must be made by the trustee on an ongoing annual basis.

[¶ 2](#P92_5562) is former ¶ 1 revised to provide that only certain life insurance policy proceeds resulting from the death of the life insured are excluded in the determination of trust profits. This reflects the amendment to the definition of "disposition" in subsection 148(9) which provides that a payment on death under a non-exempt life insurance policy acquired after December 1, 1982 is considered a disposition of an interest in a life insurance policy, applicable for dispositions occurring after November 12, 1981.

[¶ 3](#P93_6964) is former ¶ 2 revised to indicate that operating expenses cannot be charged against forfeited amounts. Also, the reference to life insurance proceeds has been removed because a trust's gross income may include life insurance proceeds resulting from the death of the life insured (see ¶ 2).

[¶ 4](#P104_7774) is former ¶ 3 revised to reflect the repeal of paragraph 3(*e*). Before 1986, under paragraph 3(*e*), an individual could deduct up to $2,000 of net capital losses from other income.

[¶ 5](#P105_8377) is former ¶ 4 revised to reflect amendments to sections 3 and 38. The amendments provide that:

- after 1985, a net capital loss for the year can no longer be used to offset up to $2,000 of other income; and

- 1990 and subsequent years, the capital gains inclusion rate is three-quarters.

[¶ 6](#P106_8852) is former ¶ 5 expanded to provide additional information pertaining to the elections under subsections 144(4.1) and (4.2).

[¶ 7](#P112_10971) is former ¶ 6 revised to reflect the amendment to section 110.1 to eliminate the $1,000 interest and dividend income deduction for 1988 and subsequent years. ¶ 7 has also been revised to delete the comment relating to subsection 144(9) since that provision is discussed in detail in new ¶ 16.

¶s [9](#P116_12029) and 10 (former ¶s 10 and 11) have been revised to delete the reference to life insurance proceeds received by the trust upon the death of the life insured. Subsections 144(3) and 144(7) do not exclude such amounts from inclusion in income.

New [¶ 14](#P152_17453) has been added to reflect new paragraph 144(7.1)(*c*) which is applicable to the 1994 and subsequent taxation years. Paragraph 144(7.1)(*c*) was added consequential on the elimination of the $100,000 capital gains exemption and the introduction of the election to recognize gains accrued to the end of February 22, 1994.

New [¶ 15](#P155_19162) has been added to indicate that no withholding is required on employer contributions to an EPSP, on allocations to the beneficiaries or on payments to the beneficiaries if the payments are not required to be included in the income of the beneficiaries.

New ¶s [16](#P157_19653) and 17 have been added to discuss the rules concerning forfeited amounts. They reflect the amendments made to subsection 144(9) applicable for the 1992 and subsequent taxation years (except that a beneficiary may elect that they not apply to the 1992 taxation year). Amended subsection 144(9) provides the person with a deductible amount rather than a tax credit as was previously available. As well, the reference to "employee" in subsection 144(9) was replaced with "person."

New [¶ 18](#P159_21067) has been added to clarify that, unless the EPSP provides otherwise, an individual who ceases to be an employee of an employer is not required to forfeit any amount under the employer's EPSP by reason of ceasing to be an employee.

New [¶ 19](#P162_21309) has been added to explain certain rules concerning non-resident EPSP beneficiaries.
