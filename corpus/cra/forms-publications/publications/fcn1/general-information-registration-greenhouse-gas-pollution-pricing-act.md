---
title: "FCN1 Registration Under the Greenhouse Gas Pollution Pricing Act"
source: https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/fcn1/general-information-registration-greenhouse-gas-pollution-pricing-act.html
...
The federal system applies in provinces and territories where a provincial or territorial carbon pricing mechanism has not been put into place or the mechanism does not meet the national criteria. Information on the national criteria can be found on the [ECCC website](https://www.canada.ca/en/environment-climate-change/services/climate-change/pricing-pollution-how-it-will-work/output-based-pricing-system/registering-facility.html). On October 23, 2018, the Government of Canada proposed a list of provinces and territories that will be subject to the federal system. The federal fuel charge is proposed to apply in Manitoba, New Brunswick, Ontario and Saskatchewan beginning April 1, 2019 and in Nunavut and the Yukon beginning July 1, 2019. These proposed provinces and territories are known as **listed provinces** for the purposes of the fuel charge. Other jurisdictions in Canada are not subject to the federal fuel charge at this time.

The information in this notice is for reference purposes only and does not replace the *Greenhouse Gas Pollution Pricing Act* or its regulations. The information described in this notice is also based, in part, on the *Draft Regulations Amending Part 1 of Schedule 1 and Schedule 2 to the Greenhouse Gas Pollution Pricing Act* (“Draft Regulations”) and the *Backgrounder: Targeted Relief for Farmers and Fishers, and Residents of Rural and Remote Communities* (“Backgrounder”). The Draft Regulations and the Backgrounder were included as attachments to the news release entitled [Department of Finance Announcing Climate Action Incentive Payments and Launch of Fuel Charge Consultations](https://www.canada.ca/en/department-finance/news/2018/10/department-of-finance-announcing-climate-action-incentive-payments-and-launch-of-fuel-charge-consultations.html) that was issued on October 23, 2018. Any reference that is made in this notice to April 1, 2019 or July 1, 2019 is as proposed in the Draft Regulations. Any reference that is made in this notice to a listed province refers to Manitoba, New Brunswick, Nunavut, Ontario, Saskatchewan and Yukon, as proposed in the Draft Regulations. As well, the Backgrounder only reflects the intentions of the Government of Canada. Any commentary contained in this notice should not be taken as a representation by the CRA that the Draft Regulations will eventually be made or adopted in their current form.

Should there be any discrepancy between the information in this notice and that contained in the Act or its regulations, the legislative provisions apply. For more information about the Act and its regulations, including all related technical publications, go to [Fuel charge technical information](https://www.canada.ca/en/revenue-agency/services/tax/technical-information/fuel-charge.html).

All legislative references in this publication are to the Act, unless otherwise stated.

## Table of Contents

- [Overview](#_Toc531266848)

- [Registration](#_Toc531266849)

- [Types of registration](#_Toc531266850)

    - [Registered distributor](#_Toc531266851)

    - [Registered importer](#_Toc531266852)

    - [Registered emitter](#_Toc531266853)

    - [Registered user of fuel](#_Toc531266854)

    - [Registered user of combustible waste](#_Toc531266855)

    - [Registered air carrier and registered specified air carrier](#_Toc531266856)

    - [Registered marine carrier and registered specified marine carrier](#_Toc531266857)

    - [Registered rail carrier and registered specified rail carrier](#_Toc531266858)

    - [Registered road carrier](#_Toc531266859)

- [Applying for registration](#_Toc531266860)

    - [Authority for separate returns](#_Toc531266861)

    - [Cancelling a registration](#_Toc531266862)

- [Appendix – Definitions](#_Toc531266863)
...
- produces MNG or NMNG in a listed province;

- imports MNG or NMNG into a listed province from outside of Canada otherwise than in a supply tank of a vehicle;

- brings MNG or NMNG into a listed province from elsewhere in Canada otherwise than in a supply tank of a vehicle;

- delivers MNG or NMNG to another person in a listed province; or
...
- measures another person’s consumption or usage of MNG in a listed province and:
    ...
    - the MNG is delivered by way of a distribution system.
...
- the person carries on the business of selling, delivering or distributing fuel of that type and, in the ordinary course of that business, delivers fuel of that type in a listed province to:
    ...
    - a farmer at a farm if the fuel is qualifying farm fuel;

    - a fisher if the fuel is qualifying fishing fuel;

    - a greenhouse operator, as proposed in the Backgrounder, if the fuel is qualifying greenhouse fuel;

    - a remote power plant operator that generates electricity for remote communities, as the term “remote communities” is proposed to be defined in the Backgrounder if the fuel is light fuel oil as also proposed in the Backgrounder;
    ...
    - a registered emitter at its covered facility;

    - a registered user of fuel in respect of that type of fuel; or

    - another person if the fuel is, in accordance with the *Ships’ Stores Regulations*, designated as ships’ stores for use on board a conveyance of a class prescribed under those regulations; and
...
- April 1, 2019 for the listed provinces of Manitoba, New Brunswick, Ontario and Saskatchewan or July 1, 2019 for the listed provinces of Nunavut and Yukon, and:

- if the type of fuel is MNG or NMNG, the day that is the earliest of:

    - the day on which the person first produces MNG or NMNG in a listed province;

    - the day on which the person first imports MNG or NMNG in a listed province from outside of Canada otherwise than in a supply tank of a vehicle;

    - the day on which the person first brings MNG or NMNG into a listed province from elsewhere in Canada otherwise than in a supply tank of a vehicle;
    ...
    - the day on which the person first measures another person’s consumption or usage of MNG in a listed province if:
          ...
          - the MNG is delivered by way of a distribution system, or

- if the fuel is not MNG or NMNG, the day on which the person first produces fuel of that type in a listed province.
...
- if fuel of that type is in a supply tank of a vehicle; or

- if fuel of that type is gasoline, light fuel oil, kerosene or propane in a quantity that does not exceed 200 litres.
...
- the person, in the ordinary course of a business:
    ...
    - imports fuel of that type into a listed province, in a supply tank of a locomotive, from outside Canada;

    - brings fuel of that type into a listed province, in a supply tank of a locomotive, from elsewhere in Canada; or
...
- unless paragraph (b) applies, as a marine carrier in respect of the type of fuel if it can reasonably be expected that, during the calendar year that includes the particular time, all or substantially all of the fuel of that type used by the person will be used in vehicles and the greatest proportion of the fuel used in vehicles will be used in vessels; or
...
- as either a specified marine carrier or a marine carrier in respect of that type of fuel if:
    ...
    - the person is a qualifying interjurisdictional marine carrier in respect of that type of fuel throughout that calendar year that includes the particular time.
...
- the day on which the person first meets the conditions outlined above.
...
To apply for registration, a person must complete [Form L400, Fuel Charge Registration](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/l400.html).Even where a person applies for more than one type of registration, only one registration form is required, unless an application for authority for separate returns under subsection 88(1) is submitted. All applicants must also complete [Form L400-1, Fuel Charge Registration Schedule](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/l400-1.html), or [Form L400-2, Fuel Charge Registration Schedule – Road Carrier](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/l400-2.html), or both, depending on the type of registration for which they are applying.
...
- the branch or division identified in the application can be separately identified by reference to its location or the nature of activities engaged in by it; and

- separate records, books of account and accounting systems are maintained in respect of the branch or division.

A separate [Form L400, Fuel Charge Registration](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/l400.html), should be used to identify each branch or division along with [Form L400-1, Fuel Charge Registration Schedule](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/l400-1.html), or [Form L400-2, Fuel Charge Registration Schedule – Road Carrier](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/l400-2.html), or both, depending on the type of registration for which the person is applying.

The application to file separate returns should be submitted at the time of registration. The application and forms should be submitted electronically using the "Submit documents" function in [My Business Account](https://www.canada.ca/en/revenue-agency/services/e-services/digital-services-businesses/business-account.html) or by mail to the Sudbury Tax Centre at the address listed above.
...
- is suitable as a source of energy.
...
- a prescribed journey or a journey meeting prescribed conditions.
...
- a prescribed facility or property, a facility or property of a prescribed class or a facility or property meeting prescribed conditions.
...
- is a prescribed journey or a journey meeting prescribed conditions.
...
- is not a mixture of ethane, propane, butane or pentanes plus created after the ethane, propane, butane or pentanes plus have been processed into separate identifiable fuels and subsequently remixed into a blend of one or more of the fuels.
...
- between a place in Canada and a place outside Canada.
...
- the aircraft or vessel is stopped to allow for its servicing or refuelling or for emergency or safety purposes.
...
- is not butane, ethane, gas liquids, aviation turbo fuel, kerosene, naphtha, propane, pentanes plus or still gas.
...
- a combination of pentane and heavier hydrocarbons.
...
- any substance commonly referred to as “green coke” or “fuel grade coke”.
...
- using any means of altering the chemical or physical properties of a substance, material or thing.
...
- that is not a recreational vehicle, including a motor home, bus or pickup truck with attached camper, if used solely for a particular individual's personal use or enjoyment or the personal use or enjoyment of any other individual at the particular individual's expense.
...
- an auxiliary component of another vehicle, if the other vehicle is attached to the vehicle.
