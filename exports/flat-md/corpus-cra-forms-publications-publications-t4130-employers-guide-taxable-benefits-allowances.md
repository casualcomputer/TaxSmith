---
title: "Employers' Guide Taxable Benefits and Allowances"
source: https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/t4130/employers-guide-taxable-benefits-allowances.html
...
- Complete web version: Option 1 Go to the full version which has been optimized for online reading. [Review payroll topics](#ajax-guide)

- HTML version of PDF guide: Option 2 Scroll down to read the publication: T4130, Employers' Guide Taxable Benefits and Allowances.

The following [payroll topic](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll.html) relates to taxables benefits and allowances.
...
Updates were made to the reporting of security options benefits received in 2025 or June 25 to December 31, 2024 and of the deductions under paragraphs 110(1)(d), (d.1) and (d.01) for those periods. This led to changes on pages 32, 33, 36, 38 and 49.

For more information, go to [T4 slip – Information for employers](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/completing-filing-information-returns/t4-information-employers/t4-slip.html)
...
If you or a person working for you is not sure of the worker’s employment status, either one of you can request a ruling to determine the status. If you are a business owner, you can use the "Request a CPP/EI ruling" service in [My Business Account](https://www.canada.ca/en/revenue-agency/services/e-services/digital-services-businesses/business-account.html). If you are an individual, you can use the “Request a CPP/EI ruling” service in [My Account](https://www.canada.ca/en/revenue-agency/services/e-services/digital-services-individuals/account-individuals.html). You can also fill out and mail [Form CPT1, Request for a CPP/EI Ruling – Employee or Self-Employed](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/cpt1.html) to the CPP/Rulings Division at the Tax Services Office in the province or territory of your residence or place of business. See the table found on Form CPT1 for the mailing addresses. For more information on employment status, go to [CPP and EI rulings](https://www.canada.ca/en/revenue-agency/services/tax/canada-pension-plan-cpp-employment-insurance-ei-rulings.html).
...
For information on calculating payroll deductions, go to [How to calculate](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/calculating-deductions/how-to-calculate.html).

For information on filing an information return, go to [When to file information returns](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/file-information-returns-slip-summaries/when-to-file.html).

## Table of Contents

- [Chapter 1 – General information](#P181_7125)

    - [What is a benefit, an allowance, or a reimbursement](#bnft_llwnc_xpns_rmbrsmnt)
    ...
    - [What are your responsibilities](#P192_7881)

          - [Determine if the benefit is taxable](#benefit_taxable)

          - [Calculate the value of the benefit](#calculate_value)

          - [Calculate payroll deductions](#calculate)

          - [File an information return](#file_inforeturn)

    - [Employee's allowable employment expenses](#P1334_1789466)

- [Chapter 2 – Automobile and motor vehicle benefits and allowances](#P228_14209)

    - [Definitions](#definitions)

          - [Automobile](#P237_15820)

          - [Employee](#employee)

          - [Motor vehicle](#P231_14441)

          - [Personal driving (personal use)](#personal_driving)

          - [Vehicle](#vehicle)

    - [Keeping records](#P231_14431)

    - [Calculating automobile benefits](#P261_19130)

          - [Calculating a standby charge for automobiles you own or lease](#standby_charge)

          - [Calculating an operating expense benefit](#operating_expense)

    - [Benefit for motor vehicles not defined as an automobile](#P366_31328)

          - [Motor vehicle home at night policy](#night_policy)

          - [Reporting automobile or motor vehicle benefits](#P366_313282)

    - [Automobile and motor vehicle allowances](#P394_34391)

          - [Reasonable per-kilometre allowance](#reasonable)

          - [Per-kilometre allowance rates that are not considered reasonable](#per_kilometre)

          - [Flat-rate allowance](#flat_rate)

          - [Combination of flat-rate and reasonable per-kilometre allowances](#combination)

          - [Reimbursement or advance for travel expenses](#reimbursement_travel)

    - [Averaging allowances](#P384_33641)

          - [Reducing tax deductions at source on automobile or motor vehicle allowances](#reducing_deductions)

          - [Reporting automobile or motor vehicle allowances on the T4 slip](#reporting_t4slip)

- [Chapter 3 – Other benefits and allowances](#P464_44295)

    - [Aircraft Benefits](#Aircraft_Ben)

    - [Board and lodging](#P466_44339)

          - [Exceptions to the rules](#exceptions_rules)

    - [Board and lodging allowances paid to players on sports teams or members of recreation programs](#P473_45607)

    - [Board, lodging, and transportation – Special work sites and remote work locations](#P483_47213)

          - [Special work sites](#spcl_wrk_sts)

          - [Remote work locations](#remote_wl)

          - [Payroll deductions](#payroll_ded)

    - [Cell phone and internet services](#P1077_134813)

    - [Child care expenses](#P1048_130721)

    - [Counselling services](#P504_49551)

    - [Disability-related employment benefits](#P504_495514)

          - [Payroll deductions](#drpd)

    - [Discounts on merchandise and commissions from personal purchases](#P494_486921)

    - [Education benefits](#P494_48692)

          - [Educational allowances for children](#allowances_children)

          - [Subsidized school services](#P1058_131994)

          - [Scholarships, bursaries, tuition, and training](#P652_71232)

          - [Scholarship and tuition fees](#scholarship_and)

    - [Employment insurance premium rebate](#employment_insurance)

    - [Gifts, awards, and long-service awards](#P515_51151)

          - [Rules for gifts and awards](#rules_for_gifts)

          - [Value](#value)

          - [Policy for non-cash gifts and awards](#P1321_9745)

          - [Long-service awards](#lsa)

          - [Awards from a manufacturer](#manufacturer)

    - [Group term life insurance policies – Employer-paid premiums](#P860_107067)

          - [Calculating the benefit](#calculating_benefit)

          - [Reporting the benefit](#reporting_benefit)

    - [Housing or utilities](#P720_82629)

          - [Housing or utilities – benefit](#horu_benefit)

          - [Housing or utilities – allowance](#horu_allowance)

          - [Reporting the benefit](#rprtng_th_bnft_hsng)

          - [Clergy residence](#clergy_residence)

    - [Income maintenance plans and other insurance plans](#p800_662)

          - [Non-group plans](#nongroup_plans)

          - [Group sickness or accident insurance plans](#sickness)

          - [Employee-pay-all plans](#payall)

          - [Group disability benefits – insolvent insurer](#insolvent_insurer)

    - [Loans – interest-free and low-interest](#P887_111004)

          - [Exceptions](#toborrowers)

          - [Loans received because of employment](#P897_112354)

          - [Loans received because of shareholdings](#because_shareholdings)

          - [Home-purchase loan](#loan)

          - [Home-relocation loans](#hm_rlctn_lns)

          - [Forgiven loans](#forgiven)

          - [Reporting the benefit](#reporting_box14)

          - [Prescribed interest rates](#P958_120041)

    - [Loyalty and other points programs](#P701_804221)

    - [Meals](#P1031_128523)

          - [Overtime meals or allowances](#P103_12852)

          - [Subsidized meals](#subsidized)

    - [Medical expenses](#P678_76356)

    - [Moving expenses and relocation benefits](#P557_58074)

          - [Moving expenses paid by employer that are not a taxable benefit](#nota_taxben)

          - [Moving expenses paid by employer that are a taxable benefit](#are_taxben)

          - [Non-accountable moving allowances](#P604_64564)

    - [Municipal officer's expense allowance](#P557_580744)

    - [Parking](#P1063_132847)

    - [Pooled registered pension plans (PRPP)](#PRPP)

    - [Power saws and tree trimmers](#P106_132848)

    - [Premiums under provincial hospitalization, medical care insurance, and certain Government of Canada plans](#P989_121254)

    - [Private health services plan premiums](#P981_120285)

    - [Professional membership dues](#P989_1212545)

    - [Recreational facilities and club dues](#P685_77576)

    - [Registered retirement savings plans (RRSPs)](#P1021_126791)

          - [Payroll deductions](#pd_rrsp)

    - [Security options](#P747_88033)

          - [Taxable benefit](#Txble_bnfit)

          - [Cash-outs](#cashout)

          - [Payroll Deductions](#Pyrll_ddctns)

          - [Security options deduction – Paragraph 110(1)(d)](#p5149-176)

          - [Security options deduction for the disposition of shares of a Canadian-controlled private corporation (CCPC) – Paragraph 110(1)(d.1)](#security_options)

    - [Social events](#P747_880331)

    - [Spouse's or common-law partner's travelling expenses](#P631_68967)

    - [Tax-free savings account (TFSA)](#P51_5115)

    - [Tickets](#tckts)

          - [Reporting the benefit](#rprtng_bnft_tckts)

    - [Tool reimbursement or allowance](#P801_96704)

    - [Transportation passes](#trnsprttn_psss)

          - [Airline passes for employees and retirees of an airline company](#arln_pss_fr_th_mplys)

          - [Transit passes](#P708_81124)

          - [Transit passes – employees of a transit company](#tp_employeetc)

    - [Travel allowance](#P639_69981)

          - [Part-time employee](#part_time)

          - [Salesperson and clergy](#salesperson)

          - [Other employees](#other)

          - [Reasonable travel allowances](#reasonable_allowances)

    - [Uniforms and protective clothing](#P1097_138033)

- [Chapter 4 – Housing and travel assistance benefits paid in a prescribed zone](#P1113_140104)

    - [Accommodation or utilities provided by the employer](#P1120_141125)

          - [Places with developed rental markets](#P1122_141401)

          - [Places without developed rental markets](#P1126_141865)

          - [Allowable ceiling amounts](#aca)

    - [Board, lodging, and transportation at a special work site in a prescribed zone](#P1149_144895)

    - [Travel assistance benefits](#P1163_147587)

          - [Medical travel assistance](#mta)

- [Chapter 5 – Remitting the GST/HST on employee benefits](#P1206_156732)

    - [Employee benefits](#P1210_157344)

          - [Employee does not pay the GST/HST on taxable benefits](#Empl_ds_nt_py_GST_txble_bnft)

          - [Find out if you have to remit GST/HST on employee taxable benefits](#Do_you_rmt_GST/HST?)

    - [Situations where you are not considered to have collected the GST/HST](#P1214_158364)

    - [How to calculate the amount of the GST/HST you are considered to have collected](#P1240_162902)

          - [Value of the benefit](#P1249_163844)

          - [Automobile operating expense benefits](#aoeb)

          - [Benefits other than automobile operating expense benefits](#p2062)

    - [When and how to report the GST/HST you are considered to have collected](#Whn_hw_rprt_GST_cnsdrd_cllctd)

          - [Automobile benefits – standby charges, operating expense benefit, and reimbursements](#Auto_bnfts_stndby_chrgs_oprtng_xpnse_bnft)

    - [Input tax credits (ITCs)](#P1264_167381)

          - [ITC restrictions](#P1268_168465)

    - [Property acquired before 1991 or from a non-registrant](#P1284_171697)

- [Benefits chart](#P1334_178946)

- [Digital services](#digital_services)

    - [Handle your business taxes online](#handling)

          - [Receive your CRA mail online](#rcv_cra_mail)

          - [Create a pre-authorized debit agreement from your Canadian chequing account](#auth_wd)

- [For more information](#P37_56)

    - [If you need help](#P0823_23784)

    - [Direct deposit](#dd)

    - [Forms and publications](#P37840_6123)

    - [Electronic mailing lists](#elctrnc_mailing_list)

    - [Related publications](#P47_928)

    - [Tax Information Phone Service (TIPS)](#tips)

    - [Teletypewriter (TTY) and Video Relay Service (Canada VRS) users](#tty)

    - [CRA service feedback and program](#cpts_dispt)

          - [Service complaints](#P1256_03458)

          - [Reprisal complaints](#rep_cmplt)

    - [Due dates](#due_dts)

    - [Cancel or waive penalties and interest](#cncl_wve_pen_int)
...
For more information, go to [Automobile or motor vehicle benefits – Allowances or reimbursements provided to an employee for the use of their own vehicle](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/automobile-motor-vehicle-allowances.html).

The benefit may be paid in **cash**(such as a meal allowance or reimbursement of personal cellular phone charges), or provided in a manner other than cash, such as a parking space or a gift certificate. For more information and examples, go to [Pensionable and insurable earnings](https://www.canada.ca/en/revenue-agency/services/tax/canada-pension-plan-cpp-employment-insurance-ei-rulings/cpp-ei-explained/canada-pension-plan-employment-insurance-explained-10.html).

The manner in which you pay or provide the benefit to your employee will affect the payroll deductions you have to withhold. For more information, see [Calculate payroll deductions](#calculate).
...
Use the [Benefits chart](#P1334_178946) to find out if you should include GST/HST in the value of the benefit. Some benefits have further information about GST/HST in the topic specific section.
...
- a taxable benefit that is an **exempt supply** or a **zero-rated supply** as defined in the [Excise Tax Act](http://laws-lois.justice.gc.ca/eng/acts/E-15/)

For more information on exempt or zero-rated supplies, go to [Type of supply](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/gst-hst-businesses/charge-collect-type-supply.html).

If you are a GST/HST registrant, you may have to remit the GST/HST for the taxable benefits you provide to your employees. For more information, go to [About the GST/HST on benefits](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/calculating-deductions/making-deductions/about-gst-hst-benefits.html) or see [Chapter 5 – Remitting the GST/HST on employee benefits](#P1206_156732).
...
If your employee has pensionable earnings above the annual maximum pensionable earnings, you will also have to deduct second additional CPP contributions (CPP2).

If the **employment** is not pensionable under the CPP, then any taxable benefits paid in cash are not pensionable and CPP contributions should not be withheld. For more information, go to [How to calculate](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/calculating-deductions/how-to-calculate.html).
...
If the **employment** is not insurable under the [Employment Insurance Act](http://laws-lois.justice.gc.ca/eng/acts/E-5.6/), then any taxable benefits paid in cash are not insurable and EI premiums should not be withheld. For more information, go to [How to calculate](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/calculating-deductions/how-to-calculate.html).
...
A near-cash benefit is one that functions as cash, or something that can easily be converted to cash, such as a security, stock, or gold nugget. For more information on near-cash benefits, see [Gifts, awards, and long-service awards](#P515_51151).
...
- The value of board and lodging an employee receives during a period in which you pay the employee a salary in cash. For more information, see [Board and lodging](#P466_44339)

- Employer-paid RRSP contributions when the employee can withdraw the amounts. For more information, see [Registered retirement savings plans (RRSPs)](#P1021_126791)
...
For more information on calculating payroll deductions, go to [Payroll deductions and contributions](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/calculating-deductions.html).

##### Benefits chart

Use the [Benefits chart](#P1334_178946) to find out if you should deduct CPP contributions and EI premiums on the **taxable** amounts, and which codes to use to report the taxable amounts on an employee's T4 slip. The chart also shows whether to include GST/HST in the value of the benefit for income tax purposes.
...
- [Calculate payroll deductions and contributions](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/calculating-deductions.html)

- [When to file information returns](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/file-information-returns-slip-summaries/when-to-file.html)

- [Claiming deductions, credits, and expenses](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/deductions-credits-expenses.html)

- [Travel expenses](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/travel-expenses.html)
...
You have to fill out and sign [Form T2200, Declaration of Conditions of Employment](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t2200.html), and give it to your employee so they can deduct employment expenses from their income. By signing the form, you are only certifying that the employee met the conditions of employment and **had to pay for** the expenses under their employment contract.
...
- [Archived Interpretation Bulletin IT-63R5, Benefits, Including Standby Charge for an Automobile, from the Personal Use of a Motor Vehicle Supplied by an Employer – After 1992](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it63r5.html)

- [What is a taxable benefit](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances.html)
...
If the vehicle you provide to your employee is not included in the definition of automobile as described, see [Benefit for motor vehicles not defined as an automobile](#P366_31328).

Zero-emission passenger vehicles (ZEPVs) are automobiles. For more information about ZEPVs, see [What kind of vehicle do you own?](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/deductions-credits-expenses/line-22900-other-employment-expenses/motor-vehicle-expenses.html).

For more information on what is defined under automobile, go to [Automobile or motor vehicle benefits – Allowances or reimbursements provided to an employee for the use of their own vehicle](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/automobile-motor-vehicle-allowances.html).
...
For more information, go to [Line 22900 – Other employment expenses](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/deductions-credits-expenses/line-22900-other-employment-expenses.html).

#### Personal driving (personal use)

You may provide an automobile to your employee to use in performing their duties of office or employment. Personal driving is **any driving** done for the purposes **not** related to employment.

Whatever the situation, if your employee drives your vehicle for personal reasons or you reimburse your employee for the personal driving of their own vehicle, there is a taxable benefit that has to be calculated and included in their income.
...
To determine if you made the automobile available to your employee and if it was used for personal driving, go to [Automobile provided by the employer](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/automobile-motor-vehicle-benefits/automobile.html).
...
- You need to provide transportation to your employee who works at a special work site or a remote location. If so, see [Board, lodging, and transportation – Special work sites and remote work locations](#P483_47213)
...
You can use the following tools to determine if the automobile benefit is taxable and calculate the benefits:

- [Automobile Benefits Online Calculator – Disclaimer](https://www.canada.ca/en/revenue-agency/services/e-services/digital-services-businesses/automobile-benefits-online-calculator-disclaimer.html)

- **Worksheet**–You can get [Form RC18, Calculating Automobile Benefits](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/rc18.html), by going to [Forms and publications](https://www.canada.ca/en/revenue-agency/services/forms-publications.html) or by calling **1-800-959-5525**

#### Calculating a standby charge for automobiles you own or lease

The standby charge is for the benefit your employee (or a person who does not deal at arm’s length with the employee) gets when your owned or leased automobile is made available for their personal use, by you or another person, because of the employee’s current, previous, or intended office or employment. Any reimbursements you receive from the employee, other than expenses relating to the operation of the automobile, will decrease the standby charge that has to be included in your employee's income.
...
For more details on standby charges calculation and examples, go to [Automobile provided by the employer](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/automobile-motor-vehicle-benefits/automobile.html).
...
- The [Automobile Benefits Online Calculator – Disclaimer](https://www.canada.ca/en/revenue-agency/services/e-services/digital-services-businesses/automobile-benefits-online-calculator-disclaimer.html), for 2018 and subsequent years

- [Form RC18, Calculating Automobile Benefits](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/rc18.html)
...
The simplified calculation has certain conditions that the employee has to meet. If the conditions are not met, you have to use the detailed calculation. To find out which calculation method is better for your employee, use [Form RC18, Calculating Automobile Benefits](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/rc18.html).

The following information will help you fill in Form RC18 and the [Automobile Benefits Online Calculator – Disclaimer](https://www.canada.ca/en/revenue-agency/services/e-services/digital-services-businesses/automobile-benefits-online-calculator-disclaimer.html).
...
If you operate a fleet or pool of automobiles, go to [Fleet operations](#fo).
...
See the section on [Personal driving (personal use)](#personal_driving).
...
For more information on grouping automobiles by average cost, see [archived Interpretation Bulletin IT-63R, Benefits, Including Standby Charge for an Automobile, from the Personal Use of a Motor Vehicle Supplied by an Employer – After 1992](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it63r5.html).

##### Automobile you lease

You must use the detailed calculation to calculate the standby charge for employer leased automobiles. The following information will help you fill in [Form RC18](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/rc18.html) and the [Automobile Benefits Online Calculator – Disclaimer](https://www.canada.ca/en/revenue-agency/services/e-services/digital-services-businesses/automobile-benefits-online-calculator-disclaimer.html)*.*
...
The operating expense benefit is the benefit your employee (or a person who does not deal at arm’s length with the employee) gets when the owned or leased automobile is made available for their personal use, by you or another person, because of the employee’s current, previous, or intended office or employment, and you (or another person) pays for the operating expenses related to personal use (including the GST/HST and PST). The operating expense benefit only applies if there is, or would be, a standby charge benefit to the employee or a person who does not deal at arm’s length with the employee.
...
The fixed rate for 2025 is 34¢ per kilometre of personal use (including the GST/HST and PST).

If the employee's main source of employment is selling or leasing automobiles, the fixed rate for 2025 is 31¢ per kilometre of personal use (including the GST/HST and PST).
...
In 2025, you provided your employee with an automobile. She drove 30,000 kilometres during the year, with 10,000 kilometres for personal use.
...
If you provide an automobile to an employee and you require your employee to pay a third party for part or all of the operating expenses, such as gas or oil changes, (including the GST/HST and PST) in the year, administratively, the CRA will allow you to deduct the portion of the expenses paid by the employee that are attributable to personal use from the operating expense benefit that you calculated. Your records have to show that the employee paid the expenses directly to the third party. For more detailed information on operating expenses, go to [Automobile provided by the employer](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/automobile-motor-vehicle-benefits/automobile.html).
...
In 2025, you provided your employee with an automobile. He drove 36,000 kilometres during the year, 12,000 kilometres of which were for personal use.

You paid $3,000 in associated insurance and maintenance during the year. Your employee paid $1,500for gas and oil changes. He did not reimburse you for any of your costs and you did not reimburse him for any of his costs.

1) Calculate the employee’s operating expense benefit using the flat-rate calculation as follows:

12,000 km x 34¢ = $4,080
...
Administratively, you can calculate the taxable benefit for your employee's personal use of the motor vehicle between home and work using the rates shown under [Fixed rate calculation](#fixed) as long as your employee meets **all** of the following conditions:

1. The motor vehicle is not an [Automobile](#P237_15820)
...
- your employee is on call to respond to emergencies (see [Note](#Note)), and you provide the vehicle so the employee can respond more effectively to emergencies
...
- Your employee is on call for emergencies (see [Note](#Note)), and has to use a vehicle which:
...
For examples of situations where transportation to and from home is considered a taxable benefit, go to [Examples – Transportation to and from home](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/automobile-motor-vehicle-benefits.html). For more details on vehicle home at night policy, go to [Automobile provided by the employer](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/automobile-motor-vehicle-benefits/automobile.html).
...
- for more information on payroll deductions and calculate the GST/HST related to the taxable benefit, go to [Automobile or motor vehicle benefits – Allowances or reimbursements provided to an employee for the use of their own vehicle](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/automobile-motor-vehicle-allowances.html).
...
Employees receiving a taxable allowance may be able to claim allowable expenses on their income tax and benefit return. For more information, see [Employee's allowable employment expenses](#P1334_1789466) or go to [Automobile or motor vehicle benefits – Allowances or reimbursements provided to an employee for the use of their own vehicle](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/automobile-motor-vehicle-allowances.html).
...
The per-kilometrerates that the CRA usually considers reasonable are the amounts prescribed in section 7306 of the [Income Tax Regulations](https://laws.justice.gc.ca/eng/regulations/C.R.C.%2C_c._945/page-64.html#docCont). Although these rates represent the maximum amount that you can deduct as business expenses, you can use them as a guideline to determine if the allowance paid to your employee is reasonable. The type of vehicle and the driving conditions are other factors used to determine whether an allowance is considered to be reasonable.
...
Rates for previous tax years can be found in older versions of this guide or in section 7306 of the [Income Tax Regulations](https://laws.justice.gc.ca/eng/regulations/C.R.C.%2C_c._945/page-64.html#docCont).
...
The reasonable per-kilometre allowance paid for travel outside the district is **not included in income**. The amount based on a flat-ratepaid for travel inside the district is **taxable**, since it is not based only on the number of kilometres for which the vehicle is used in connection with the employment.
...
For more information on vehicle allowances, go to [What is a taxable benefit](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances.html).

#### Reducing tax deductions at source on automobile or motor vehicle allowances

In many cases, allowances that are not based only on a reasonable per-kilometre rate can later be substantially offset by the employees' expense deductions on their income tax and benefit returns. In these situations, employees can ask to reduce their tax deductions on their remuneration by filling out and sending in a [Form T1213, Request to Reduce Tax Deductions at Source](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t1213.html), or a written request to any tax services office along with the following information:
...
If you have a number of employees in the same situation, you can get a blanket waiver for the group. This way, every employee does not have to make an individual request.
...
For more information about aircraft benefits, go to [Taxable benefit for the personal use of an aircraft](https://www.canada.ca/en/revenue-agency/services/tax/technical-information/compliance-manuals-policies/taxable-benefit-personal-aircraft.html).

### Board and lodging

You may give your employee board and lodging which means that you provide them with accommodations and, in some cases, food. If you provide only meals to an employee, see [Meals](#P1031_128523).
...
- If you provide board, lodging, or transportation, or allowances for board, lodging, or transportation to an employee who works at a special work site or a remote location, see [Board, lodging, and transportation – Special work sites and remote work locations](#P483_47213)

### Board and lodging allowances paid to players on sports teams or members of recreation programs

You can exclude up to $441 (for 2025) per month from income for a board and lodging allowance for a participant or member of a sports team or recreational program if **all** of the following conditions are met:
...
If the special work site is in a **prescribed zone**, see [Board, lodging, and transportation at a special work site in a prescribed zone](#P1149_144895).

For more information, go to [Board, lodging, and transportation at a special work site in a prescribed zone](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/housing-travel-assistance-benefits-paid-a-prescribed-zone/board-lodging-transportation-a-special-work-site.html).
...
If **all** of the conditions listed under [Board and lodging](#board_lodging) noted above are met, you and the employee should fill out [Form TD4, Declaration of Exemption – Employment at a Special Work Site](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/td4.html). This allows you to exclude the benefit or allowance from the employee's income. If you fill out Form TD4, **do not** include the amounts in box 14, "Employment income," or in the "Other information" area under code **30** at the bottom of the employee's T4 slip. After you fill out Form TD4 with the employee, keep it with your payroll records.

If all of the above-noted conditions are not met, **do not** fill out Form TD4. Treat the total amounts as part of the employee's income. Make the necessary deductions and report the amounts on the employee's T4 slip. This also applies to any allowance for board, lodging, and transportation that is more than a reasonable amount.
...
If you need help determining whether a location qualifies as remote, see [archived Interpretation Bulletin IT-91R4, Employment at Special Work Sites or Remote Work Locations](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it91r4.html).

##### Form TD4, Declaration of Exemption – Employment at a Special Work Site

When there is an exemption for board, lodging, or transportation allowances you pay to employees who work at a remote work location, **do not**fill out [Form TD4](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/td4.html).
...
For more information, go to [Cellular phone and Internet services](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/provided/cellular-phone-internet-services.html).
...
For more information, go to [Benefits provided to an employee who has a severe or prolonged impairment (disability)](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/disability-related-employment-benefits.html).
...
However, if the employee’s child has to live away from your employee’s home in the place, where the employee is required to live because of their employment, the educational allowance **may not be taxable** if **all**of the following conditions are met:
...
If you get any questions, you can refer them to the [Federal Income Tax and Benefit Guide](https://www.canada.ca/en/revenue-agency/services/forms-publications/tax-packages-years/general-income-tax-benefit-package/5000-g.html).

### Employment insurance premium rebate

As an employer, you may be eligible for a reduction in the employer EI premium rate that you use to calculate your share of the EI premiums if you offer income protection coverage, such as a wage loss replacement plan or other income maintenance plan, to your employees that reduce the EI benefits payable to an employee. For more information, go to [How to reduce the EI premium rate if you provide your employees with a short-term disability plan](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/payroll-deductions-contributions/employment-insurance-ei/reduce-ei-premium-rate-you-provide-your-employees-a-short-term-disability-plan.html).
...
You have to return 5/12 of any savings to your employees in the year in which you received the EI premium reduction, or within the first four months of the following year. This savings can either be given to your employee in cash, such as a cash allowance or a cash rebate, or indirectly through increased employer contributions to an employee's health and welfare trust, group sickness or accident insurance plan, private health services plan, or in any other manner. These indirect benefits will only be tax-free (i.e. not included in the employee's employment income) if they are given to the employee in the form of a benefit specifically exempt from taxation under paragraph 6(1)(a) of the [Income Tax Act](http://laws-lois.justice.gc.ca/eng/acts/I-3.3/index.html).

If the benefit is taxable, you must include it in your employee's income in the year the employee received it. For more information, see [Benefits chart](#P1334_178946).
...
Cash and near-cash gifts or awards are always a taxable benefit for the employee. A near-cash item is one that functions as cash, or an item that can be easily converted to cash, such as gold nuggets, securities, or stocks. For more information, see [Rules for gifts and awards](#rules_for_gifts) and [Policy for non-cash gifts and awards](#P1321_9745), or go to [Gifts, awards, and long-service awards](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/gifts-awards-social-events/gifts-awards-long-service-awards.html).

You give your employee a $100 gift card or gift certificate to a department store. The employee can use this to purchase whatever merchandise or service the store offers. A $100 gift card or gift certificate that does not meet the conditions under our administrative policy is considered as near-cash. The CRA considers the gift card or gift certificate to be an additional remuneration that is a taxable benefit for the employee because it functions in the same way as cash.
...
For more information on gifts and awards outside the CRA’s policy, go to [Gifts and awards outside our policy](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/loyalty-points-programs.html) and Policy for non-cashgifts and wards, or go to [What is a taxable benefit](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances.html).
...
- A log is kept to record gift card information containing**all** of the following: This includes gift certificates, chip cards and electronic gift cards. If the gift card meets all these conditions, it is considered non-cash for the purpose of the CRA's administrative policy and can be used to provide gifts and awards as part of the $500 limit. If the card does not meet these conditions, it is considered a near-cash benefit and is taxable. You **must** review the terms and conditions of the gift card to make sure it meets the conditions of the CRA's administrative policy above. You **must** complete this review on a **case by case** basis.
...
As well as the gifts and awards in the policy stated above, you can, once every five years, give your employee a non-cash long-serviceor anniversary award valued at $500 or less, tax free. The award must be for a minimum of five years' service, and it has to be at least five years since you gave the employee the last long-service or anniversary award. Any amount over the $500 is a taxable benefit. Gift cards which meet the conditions under the [Policy for non-cash gifts and awards](#policy-non-cash) above can be used to give a non-cash long-service or anniversary award under this policy.
...
For more information, go to [Rules for gifts and awards](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/gifts-awards-social-events/gifts-awards-long-service-awards.html).
...
Except as indicated in the next paragraph, for former employees or retirees, report the benefit on a [T4A slip](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/completing-filing-information-returns/t4a-information-payers.html) using code **119** in the "Other information" area, regardless of the amount. The $500 reporting threshold for T4A slips, which is described on [When to file information returns](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/file-information-returns-slip-summaries/when-to-file.html)", **does not** apply.
...
If the accommodation you provide to the employee is in a prescribed zone, see [Accommodation or utilities provided by the employer](#P1120_141125).

If your employee is a member of the clergy or a religious order or a regular minister of a religious denomination, they might be entitled to claim a clergy residence deduction. For more information, see [Clergy residence](#clergy_residence).
...
If the accommodation you provide is smaller than your employee needs, the CRA does not allow any reduction in value.
...
To claim the deduction, the employee has to fill out parts A and C of [Form T1223, Clergy Residence Deduction](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t1223.html). You have to fill out Part B and sign the form to certify that this employee has met the required conditions. The employee does not have to file the form with their income tax and benefit return, but has to keep it in case the CRA asks to see it.
...
- gives you a completed [Form T1223, Clergy Residence Deduction](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t1223.html)
...
Although the clergy residence deduction and the utilities share of the benefit can be excluded from income for the purpose of calculating tax deductions and CPP, you still have to report it on your employee's T4 slip. Special rules apply if you pay for utilities (or provide them) for a member of the clergy. For more information, go to [Fill out the slips and summaries](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/completing-filing-information-returns.html).

For more information, see [archived Interpretation Bulletin IT-141R, Clergy Residence Deduction](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it141r-consolid.html).
...
For more information on employee-pay-all plans, go to [CPP/EI Explained](https://www.canada.ca/en/revenue-agency/services/tax/canada-pension-plan-cpp-employment-insurance-ei-rulings/cpp-ei-explained.html) and choose "[Wage Loss Replacement Plans](https://www.canada.ca/en/revenue-agency/services/tax/canada-pension-plan-cpp-employment-insurance-ei-rulings/cpp-ei-explained/canada-pension-plan-employment-insurance-explained-15.html)" or see [archived Interpretation Bulletin IT-428, Wage Loss Replacement Plans](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it428.html).
...
If a person is both an employee and a shareholder, it is a question of fact whether a particular indebtedness arose because of shareholdings or because of an office or employment. For more information, see [Income Tax Folio S3-F1-C1, Shareholder Loans and Debts.](https://www.canada.ca/en/revenue-agency/services/tax/technical-information/income-tax/income-tax-folios-index/series-3-property-investments-savings-plans/folio-1-shares-shareholders-security-transactions/income-tax-folio-s3-f1-c1-shareholder-loans-debts.html)

The benefit is generally calculated as the amount of interest that the person would have paid on the loan or debt for the year at the prescribed rates (for more information, see [Prescribed interest rates](#P958_120041)), **minus** the amount of interest that they paid on the loan in the year or no later than 30 days after the end of the year.

Special rules apply to certain loans or debt and to home-relocation loans. For more information, see [Exceptions](#toborrowers) below and [Home-relocation loans](#hm_rlctn_lns).
...
- You include all or part of the loan or debt (such as, a loan or debt forgiven in whole or in part) in the income of a person or partnership. See [Forgiven loans](#forgiven) for more information. Where only part of the loan or debt has been included in income, an interest benefit must still be calculated for the portion of the loan or debt that remains outstanding
...
Under our administrative policy, if the loan is received or a debt is incurred because of employment, the interest benefit is not taxable if all of the following apply:

- Total amount of loans received is $10,000 or less per calendar year (includes loans of different term durations and principal amounts)

- Term of the loan(s) is 60 days or less

- Loan is not received because of shareholdings

If the full principal of the loan is not repaid within 60 days, the interest benefit is taxable. If the term of the loan spans two calendar years, the loan will count as part of the $10,000 limit for the year in which the loan was received.
...
Sometimes these rules do not apply. For more information, see [Exceptions](#toborrowers).
...
For information about similar taxable benefits resulting from loans received because of services performed by a corporation that carries on a personal services business, see [archived Interpretation Bulletin IT-421R, Benefits to individuals, corporations and shareholders from loans or debt](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it421r2.html).
...
- the amount of the loan or debt may be required to be included in the income of the person or partnership. For more information, see [Income Tax Folio S3-F1-C1, Shareholder Loans and Debts](https://www.canada.ca/en/revenue-agency/services/tax/technical-information/income-tax/income-tax-folios-index/series-3-property-investments-savings-plans/folio-1-shares-shareholders-security-transactions/income-tax-folio-s3-f1-c1-shareholder-loans-debts.html)
...
The calculation of the benefit is modified where one or more such loans are considered to have been made under a back-to-back shareholder loan arrangement. For more information on back-to-back shareholder loans, see [Tax Measures: Supplementary Information](https://www.budget.canada.ca/2016/docs/tm-mf/si-rs-en.html).
...
To calculate the benefit for a home-purchase loan, see [Loans received because of employment](#P897_112354).
...
To calculate the benefit for the home-relocation loan, see [Loans received because of employment](#P897_112354).
...
A loan to an employee may be partly or fully forgiven (the employee does not have to repay the loan). In either case, the forgiven amount is considered employment income and is added to the employee's T4 slip for the year the amount is forgiven. For more information, see [archived Interpretation Bulletin IT-421R2, Benefits to individuals, corporations and shareholders from loans or debt](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it421r2.html).
...
To get the current prescribed rates of interest, go to [Prescribed interest rates](https://www.canada.ca/en/revenue-agency/services/tax/prescribed-interest-rates.html).
...
For examples of situations where loyalty and other points programs are considered taxable benefits, go to [Loyalty or other points programs](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/loyalty-points-programs.html).
...
For examples of situations where overtime meals, or allowances for overtime meals, are considered taxable benefits, go to [Examples – Overtime meals or allowances](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/examples-overtime-meals-allowances.html).
...
- [Benefits provided to an employee who has a severe or prolonged impairment (disability)](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/disability-related-employment-benefits.html)

- [Medical expenses](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/medical-expenses.html)

- [Private Health Services Plan](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/benefits-allowances-chart/premiums-contributions.html)
...
If you paid allowances to your employee for incidental moving expenses that they do not have to account for, see [Non-accountable moving allowances](#P604_64564).
...
For more information on the deduction for moving expenses that is available to your employees, go to [Moving expenses and relocation benefits](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/provided/moving-expenses-relocation-benefits.html).
...
In March 2025, you compensated Clara, your employee, for a $40,000 loss she incurred on the sale of her house. The loss was an eligible housing loss. Clara started to work at her new workplace in June 2025.

The taxable benefit you will report on Clara's 2025 T4 slip will be $12,500, calculated as follows:

½ × ($40,000 − $15,000)

In June 2024, you agreed to compensate Paul, your employee, for any eligible housing loss incurred on the sale of his house. Paul started to work at his new work location on December 1, 2024.

Paul's eligible housing loss amounted to $65,000. You paid out the compensation in two payments: $30,000 in September 2024 and $35,000 in February 2024.

Paul's taxable benefit in2024was $7,500 (half of the amount paid in 2025 that is more than $15,000).

Paul's taxable benefit in 2025 is $17,500. This is calculated as follows:

- half of the total of amounts paid in 2024 and 2025 that is more than $15,000 (½ × [$65,000 − $15,000] = $25,000)

**minus**

- the amount included in income in 2024 ($7,500)

For more information on housing losses, go to [Moving expenses and relocation benefits](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/provided/moving-expenses-relocation-benefits.html).
...
- If your employee has a disability, the parking benefit is generally **not** taxable. For more information, see [Disability-related employment benefits](#P504_495514)
...
The CRAdoes not require you to include a benefit in your employee's income in the following situations:
...
- You provide a limited number of parking spaces where all of the following apply:
...
For more information on scramble parking, go to [Parking](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/parking.html).
...
For more information about PRPPs, go to [The Pooled Registered Pension Plan (PRPP)](https://www.canada.ca/en/revenue-agency/services/tax/pooled-registered-pension-plan-prpp.html).
...
Use the [T4A slip](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t4a.html) to report these amounts for former employees or retired employees. Enter the amount under code **135**, "Recipient-paid premiums for private health services plans," in the "Other information" area at the bottom of the T4A slip.

For more information on private health services plans, go to [Private Health Services Plan](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/benefits-allowances-chart/premiums-contributions.html) and see [archived Interpretation Bulletin IT-339R2, Meaning of private health services plan (1988 and subsequent taxation years)](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it339r2.html).
...
For more information, see [archived Interpretation Bulletin IT-158R2, Employees' professional membership dues](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it158r2.html).
...
For more information, go to [Recreational facilities and club dues](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/recreational-facilities-club-dues.html).
...
Although the benefit is taxable and has to be reported on the T4 slip, you do not have to deduct income tax at source on the contributions you make to your employee's RRSPs if you have reasonable grounds to believe that the employee can deduct the contribution for the year. For details, go to [Calculate payroll deductions and contributions](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/calculating-deductions.html).
...
Include this benefit in box 14, "Employment income," and in the "Other information" area under code **38**. Also, show the deductions the employee is entitled to in the "Other information" area of the T4 - slip, as explained in the rest of this section.

The benefit included in box 14 may be reported in the "Other information" area under code 90 instead of code 38 if the benefit was received in 2025 or from June 25, 2024 to December 31, 2024. Codes 90, 91 and 92 will not be used after 2025.

For more information on security options, see [archived Interpretation Bulletin IT-113R4, Benefits to Employees – Stock Options](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it113r4.html).
...
If an employee relinquishes a stock option right to an employer in exchange for a cash payment or other in kind benefit, the employee can claim the security options deduction if eligible or the employer can claim the cash-out as an expense, but not both. If the employer chooses **not** to claim the cash-out as an expense, the employer must make an election to do so under subsection 110(1.1) by entering this amount under code **86**, "Security options election," in the "Other information" area of the T4 slip. This would allow the employee to claim the deduction under paragraph 110(1)(d). The amount you report under code **86** may be different from the taxable benefit you have to include in the employee's income in box 14 and under code **38**(or code 90 for some taxable benefits from June 25, 2024 to December 31, 2025).

If code **86** of the T4 is not entered, this means that the employer decided to claim the expense and the employee would not be allowed to claim the deduction under paragraph 110(1)(d). For more information, go to [Payroll](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll.html).
...
For more information, go to [Security options](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/security-options.html). Deduct CPP contributions and income tax.

When determining the amount of the security options benefit subject to income tax withholding, the CRA will permit the employer to reduce the benefit by 50% using the security options deduction under paragraph 10(1)(d.01). If a Security options deduction of 33.3333% is reported for the period June 25, 2024 to December 31, 2024 using code 91, the employee may use the federal worksheet to claim the remaining 16.6667% (50% minus 33.3333%) on line 24901 of their personal income tax and benefit return. Alternatively, if the employee is eligible for a deduction under 110(1)(d.01) for donated securities, they may claim 66.6667% on line 24900 to bring the total deduction to 100%.
...
- There are additional conditions where an employee receives cash instead of acquiring securities (see [Cash-outs](#cashout)), and where the security options are granted on or after July 1, 2021 (see [Annual vesting limit](#annual_vesting)).
...
If the taxable benefit is reported using code 90 for 2025 or the period from June 25 to December 31, 2024, refer to the 2025 RC4120 for information on how to report the related deduction.
...
The qualifying person is required to fill out [T2 Schedule 59](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t2sch59.html) to report non-qualifying security options beyond the $200,000 annual vesting limit.
...
| **One-half** of the amount taxable – 110(1)(d) ($200,000 vesting limit ÷ $40 grant price per share = 5,000 shares eligible for the deduction.) ($50,000 x 50%) Because only 5,000 shares were exercised, they all qualify for the deduction. |  |  | $25,000 |
...
| A = C + D - $200,000 (if the result is negative, the amount is zero) | $0 | $140,000 |  |
...
| **One-half** of the amount taxable - 110(1)(d) (120,000 shares less the 20,000 non-qualified shares = 100,000 shares eligible for the deduction) (100,000 shares x ($3 - $2) x 50%) **OR**, if the reporting exception for June 25, 2024 to December 31, 2024 applies, one-third of the amount taxable (100,000 shares x ($3 - $2) x 33.3333%) |  |  | $50,000 or**$33,333** if the reporting exception applies (in that case, the employee may claim an additional deduction of $16,667 on line 24901 of their personal income tax and benefit return or $66,667 on line 24900 if they qualify for the additional deduction on the donation of qualified securities (discussed in RC4120)) |

| Amount to be included on the T4 |  |  | 2024 tax year |

| Box 14 (may include other income) |  |  | **= $120,000** |

| Code 38 (or code 90 where the benefits were received from June 25 to December 31, 2024 and the employer is choosing to report the taxable benefit using code 90) |  |  | **= $120,000** |

| Code 39 (or code 91 where the benefits were received from June 25 to December 31, 2024 and the employer is choosing to report the taxable benefit using code 90) |  |  | **= $50,000** (or **$33,333** where the deduction is being reported for the period June 25 to December 31, 2024 using code 91. In this case, the employee may use the federal worksheet to claim an additional deduction of $16.667 on line 24901 to bring the total deduction to 50%, OR may claim a deduction of $66.667 on line 24900 if they qualify for the deduction on donation of qualified securities) |
...
Qualifying persons will be required to notify employees in writing no later than 30 days after the day the securities option agreement is entered into for non-qualified securities, and to report the issuance of securities options for non-qualified securities on [Form T2 Schedule 59](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t2sch59.html) with their income tax and benefit return.
...
If the taxable benefit is reporting using code 90 for 2025 or the period from June 25 to December 31, 2024, refer to the 2025 RC4120 for information on how to report the related deduction.
...
- The event is within the maximum annual limit for social events (total of **six employer-paid** combined in-personand virtual social events)

- If you provide a combined in-person and virtual social event to your employees, the benefit is not taxable if all of the following apply:
...
For more information, go to [What is a taxable benefit](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances.html).
...
For more information, see [archived Interpretation Bulletin IT-131R2, Convention expenses](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it131r2.html).
...
Generally, the value of tickets is considered a taxable benefit when an employer gives an employee tickets for personal use unless it is being given under the terms of the gifts and awards policy. This would also be the case if the employer gives tickets to a person with whom the employee does not deal at arm’s length (such as a family member) for a non-businessuse.
...
Employers have to fill out and sign [Form T2200, Declaration of Conditions of Employment](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t2200.html), to certify that the employee must acquire these tools as a condition of, and for use in their employment.

For more information, go to [Tool reimbursements, allowances and rental payments](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/provided/tool-reimbursement-allowance.html).
...
If you provide free or discounted passes to a member of your employee's or retired employee's family, the fair market value (FMV) of the pass is a taxable benefit for the employee. Report the retiree's benefit using code **028**, "Other income" in the "Other information" area at the bottom of the [T4A slip](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t4a.html).
...
For examples of situations where transit passes are considered taxable benefits, go to [Transportation and airline passes](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/provided/transit-passes.html)
...
For examples of situations where a travel allowance is considered a taxable benefit, go to [Travel expenses](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/travel-expenses.html).
...
For more information, see paragraph 48 in [archived Interpretation Bulletin IT-522R, Vehicle, Travel and Sales Expenses of Employees](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/it522r.html).

Your employee may be able to claim certain employment expenses on their income tax and benefit return. For more information, see [Employee's allowable employment expenses](#P1334_1789466).
...
If your employee works at a special site or a remote work location that **is not** in a prescribed zone, this chapter does not apply to you. For more information, see [Board, lodging, and transportation – Special work sites and remote work locations](#P483_47213).

For a list of places in prescribed northern zones and prescribed intermediate zones, go to [Northern residents](https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/deductions-credits-expenses/line-25500-northern-residents-deductions.html).
...
For a list of the ceiling amounts for rent and utilities and definitions for different types of accommodation, go to [Allowable ceiling amounts](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/housing-travel-assistance-benefits-paid-a-prescribed-zone/accommodation-utilities-provided-employer-a-prescribed-zone/allowable-ceiling-amounts.html).
...
You paid your employee $4,000 for board and lodging at a special work site that is in a prescribed zone. You and the employee filled out [Form TD4, Declaration of Exemption – Employment at a Special Work Site](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/td4.html).
...
You have to enter $1,200 in the "Other information" area under code **31** at the bottom of the T4 slip, even though it was not entered in the "Other information" area under code **30**. The employee will then enter $1,200 on their [Form T2222, Northern Residents Deductions](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/t2222.html).
...
- [Benefits provided to an employee who has severe or prolonged impairement (disability)](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/disability-related-employment-benefits.html)
...
Whether or not you have to make income tax deductions, you have to deduct CPP contributions and EI premiums on cash payments. You have to deduct CPP contributions on non-cash benefits if the employee also receives cash remuneration from you during the year. If the non-cash benefit is the only form of remuneration you provide to your employee in the year you do not have to make payroll deductions. For more information about the non-cash benefits withholding policy, go to [Chapter 1 – General information](#P181_7125).

##### Form TD1, Personal Tax Credits Return

Employees who live in a prescribed zone during a continuous period of at least six months (that begins or ends in the tax year) may be entitled to claim the northern residents deductions when filing their income tax and benefit returns. As a result, these employees can ask for a reduction in payroll deductions by completing the back of [Form TD1, Personal Tax Credits Return](https://www.canada.ca/en/revenue-agency/services/forms-publications/td1-personal-tax-credits-returns/td1-forms-pay-received-on-january-1-later.html).
...
For 2025, an employee living in a prescribed **northern** zone can claim the total of:

- a basic residency amount of $11.00per day for each day they live in the prescribed **northern** zone
...
However, the cost of benefits or non-cash compensation provided to an employee, commonly referred to as fringe or employee taxable benefits may be subject to the GST/HST. For the most part, the GST/HST treatment of these benefits is based on their treatment under the [Income Tax Act](http://laws-lois.justice.gc.ca/eng/acts/I-3.3/index.html).
...
If the property or service that gives rise to the taxable benefit is subject to GST/HST, you are considered to have collected the GST/HST on that benefit. However, there are situations where you will not be considered to have collected the GST/HST on taxable benefits given to employees. These situations can be found in the section titled [Situations where you are not considered to have collected the GST/HST](#P1214_158364).
...
If none of the situations apply, you are considered to have collected the GST/HSTon the taxable benefit and must calculate the amount of the GST/HST due. Go to Step 3.

**Step 3 –** If you are considered to have collected the GST/HST on a taxable benefit, you have to calculate the amount of the GST/HST due. More information on how to calculate the amount of GST/HST due can be found in the sections [Automobile operating expense benefits](#aoeb) and [Benefits other than automobile operating expense benefits](#p2062).

**Step 4 –** Include the amount of the GST/HST due on your GST/HST return and send your remittance, if applicable, with your GST/HST return for the reporting period that includes the last day of February 2026.

If the GST/HST is for a reimbursement made by an employee or an employee’s relative for a taxable benefit other than a standby charge or the operating expense of an automobile, the amount may be due in a different reporting period. For more information, see [Benefits other than automobile operating expense benefits](#benefits).
...
- A taxable benefit results from an **allowance** included in the income of the employee under paragraph 6(1)(b) of the [Income Tax Act](http://laws-lois.justice.gc.ca/eng/acts/I-3.3/index.html)

- You are restricted from claiming an input tax credit (ITC) in the situations described in section [ITC restrictions](#P1268_168465) for the GST/HST paid or payable on the property and services that give rise to the taxable benefit
...
- 11% for New Brunswick, Newfoundland and Labrador, and Prince Edward Island

- 9% for Ontario

If the last establishment where your employee ordinarily worked or to which they ordinarily reported in the year is located in a **non-participating province or territory** (the rest of Canada), you are considered to have collected 3% of the value of the benefit for GST/HSTpurposes.
...
Include the amount of the GST/HST due in your GST/HST return for the reporting period that includes the last day of February 2026.

You are a GST/HST registrant and have a monthly reporting period. Although you calculated the taxable benefits, including any GST/HST and PST, for each applicable pay period provided to your employees during 2025, you are considered to have collected the GST/HST on the taxable benefits at the end of February 2025. In your GST/HST return for the reporting period that includes the last day of February 2026, you have to include the GST/HST for the taxable benefits given to your employees in the prior calendar year on line 103 (line 105 if filed electronically) of your GST/HST return.

If the GST/HST is for a reimbursement made by an employee or an employee’s relative for a taxable benefit other than a standby charge or the operating expense of an automobile, the amount may be due in a different reporting period. For more information, see [Benefits other than automobile operating expense benefits](#p2062).

#### Automobile benefits – standby charges, operating expense benefit, and reimbursements

The benefit for an automobile provided in this situation is generally made up of a standby charge benefit plus an operating expense benefit minus any reimbursements employees make in the year for these benefits, as discussed in [Chapter 2](#P228_14209). When you are calculating the amount of GST/HST that you are considered to have collected on an automobile benefit you must take all three factors into consideration. The standby charge will be calculated at a certain percentage, and the operating expense benefit will be calculated at another. For more information, go to [Automobile provided by the employer](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/payroll/benefits-allowances/automobile/automobile-motor-vehicle-benefits/automobile.html).

In addition, the percentages used to calculate the amount of GST/HST will depend on the province or territory in which the automobile is provided as discussed above. Additional information on the GST/HST implications on automobile benefits can be found in [GST Memorandum 9.2, Automobile benefits](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/9-2.html).

As a corporation registered for the GST/HST, you buy a vehicle that is used more than 50% in commercial activities and is made available to your employee during 2025. The last establishment where the employee ordinarily reported in the year for the corporation was located in **Manitoba**.

You calculated a taxable benefit (including GST and PST) of $4,800 on the standby charge and an operating expense benefit of $600. Your employee reimbursed you $1,800 for the automobile operating expenses within 45 days of the end of 2025, so the operating expense benefit to be reported was reduced by this amount.

You claimed an input tax credit (ITC) for the purchase of the automobile and also on the operating expenses. Since the benefit is taxable under the Income Tax Act, and nosituations described in [Situations where you are not considered to have collected the GST/HST](#P1214_158364) apply, you calculate the GST remittance as follows:
...
You are considered to have collected GST in the amount of $256.62 at the end of February 2026. You have to include this amount on your GST/HST return for the reporting period that includes the last day of February 2026.
...
You are considered to have collected HST in the amount of $853.47 at the end of February 2026. You have to include this amount on your GST/HST return for the reporting period that includes the last day of February 2026.
...
Generally, commercial activities include the making of supplies of taxable property and services. For more information about what are considered to be commercial activities, go to [GST/HST for businesses](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/gst-hst-businesses.html).
...
- The consumption, use, or enjoyment of the property or service by the employee or their relative does not give rise to a taxable benefit for income tax purposes and no amounts were payable by the employee for this benefit. The most common type of non-taxable benefit is the paying of moving expenses by an employer. Moving expenses that are considered non-taxable benefits are discussed in [Moving expenses and relocation benefits](#P557_58074)
...
For more information on ITCs related to employee benefits, see [GST/HST Memorandum 9.1, Taxable Benefits (Other than Automobile Benefits)](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/9-1.html).
...
You bought a passenger vehicle from a non-registrant and made it available to your employee throughout 2025. The passenger vehicle is used more than 90% in the commercial activities of your business. You report the value of the benefit, including the GST/HST and if applicable, the PST, on the employee's T4 slip. For GST/HST purposes, you will be considered to have collected the GST/HST on this benefit even if you could not claim an ITC on the purchase of the passenger vehicle.
...
**Automobile benefit**– See examples in the section on “[Automobile benefits – standby charges, operating expense benefit, and reimbursements](#Auto_bnfts_stndby_chrgs_oprtng_xpnse_bnft)”.

**Motor vehicle benefit**– A Prince Edward Island employer provided a motor vehicle to an employee who drove it for personal and business use throughout 2025. The employer has never been a large business. The taxable benefit for the personal use is $5,100. As Prince Edward Island is a participating province, the HST considered to have been collected is calculated as follows:

**HST considered to have been collected on the motor vehicle benefit = $5,100 × 14/114 = $626.32**

You are considered to have collected the HST in the amount of $626.32 at the end of February 2026. You have to include this amount on your GST/HST return for the reporting period that includes the last day of February 2026.
...
**Subsidized Meals**– An Ontario employer provides subsidized meals to employees (such as in an employee dining room or cafeteria) throughout 2025, and the employee does not pay any amount for these meals. The cost of food, preparation and service per employees over the course of the year is $2,052 including HST. The ITCs will not be restricted on property or services purchased to make supplies of meals if the employer is acquiring the property or service generally for the use of employees, but not specifically for any particular employee.
...
You are considered to have collected the HST in the amount of $219.86 at the end ofFebruary 2026. You have to include this amount on your GST/HST return for the reporting period that includes the last day of February 2026.

**Cell phone**– An employer located in Manitoba provides the general manager of the company with a cell phone both for business and personal use throughout 2025.

The value of the taxable benefit for personal use of the cell phone for the year is $617. The employee reimbursed the employer $200 for the cell phone in December 2025. The amount of the benefit shown on the T4 is $417.
...
In this situation you have to include the GST for the reimbursement in your GST return for the reporting period that includes the date of the reimbursement (December 2025) = $200 × 5/105 = $9.52. You are considered to have collected the GST on the cell phone benefit in the amount of $16.04 at the end of February 2026. You have to include this amount on your GST/HST return for the reporting period that includes the last day of February 2026.

**Long-service award**– You bought a watch for $560(including the GST/HST and PST) for your employee to mark the employee’s 25 years of service. It was the only gift or award provided to the employee in the year. You reported a taxable benefit of $60 in box 14and under code **40**on the employee’s T4 slip.
...
| Taxable allowance or benefit | DeductCPP [Footnote1](#fn1) | DeductEI | Code for T4 slip | IncludeGST/HST |
...
| Board and lodging, if earnings also paid | yes | [Footnote2](#fn2) | 30 | [Footnote3](#fn3) |

| Cellular phone and Internet services – in cash | yes | yes | 40 | yes |

| Child care expenses – in cash | yes | yes | 40 | [Footnote4](#fn4) |

| Child care expenses – non-cash | yes | no | 40 | [Footnote4](#fn4) |

| Counselling services – in cash | yes | yes | 40 | [Footnote5](#fn5) |

| Counselling services – non-cash | yes | no | 40 | [Footnote5](#fn5) |

| Disability-related employment benefits – in cash | yes | yes | 40 | [Footnote6](#fn6) |

| Disability-related employment benefits – non-cash | yes | no | 40 | [Footnote6](#fn6) |
...
| Housing allowance, clergy – in cash | [Footnote7](#fn7) | yes | 30 | no |

| Housing allowance – in cash | yes | yes | 30 | [Footnote8](#fn8) |

| Housing benefit, clergy, rent-free or low-rent – non cash | [Footnote7](#fn7) | [Footnote9](#fn9) | 30 | [Footnote8](#fn8) |

| Housing benefit, rent-free or low-rent – non cash | yes | [Footnote9](#fn9) | 30 | [Footnote8](#fn8) |

| Housing loss – in cash | yes | yes | 40 | no |

| Interest-free and low-interest loans [Footnote6](#fn6) | yes | no | 36 | no |
...
| Medical expenses – in cash | yes | yes | 40 | [Footnote10](#fn10) |

| Medical expenses – non-cash | yes | no | 40 | [Footnote10](#fn10) |
...
| Professional membership dues – in cash | yes | yes | 40 | [Footnote11](#fn11) |

| Professional membership dues – non-cash | yes | no | 40 | [Footnote11](#fn11) |
...
| Registered retirement savings plan (RRSP) contributions – in cash | yes | [Footnote12](#fn12) | 40 | no |

| Registered retirement savings plan (RRSP) administration fees – non-cash | yes | no | 40 | [Footnote11](#fn11) |

| Scholarships and bursaries – in cash | yes | yes | 40 | no |

| Security option (Cash-outs) | yes | yes | [Footnote13](#fn13) | no |

| Security options | yes | no | [Footnote13](#fn13) | no |
...
| Tax-Free Savings Account – contributions–in cash | yes | [Footnote12](#fn12) | 40 | no |

| Tax-Free Savings Account – administrationfees – non-cash | yes | no | 40 | [Footnote11](#fn11) |
...
| Tuition fees – in cash | yes | yes | 40 | [Footnote11](#fn11) |

| Tuition fees – non-cash | yes | no | 40 | [Footnote11](#fn11) |

| Uniforms and protective clothing – in cash | yes | yes | 40 | no |

| Uniforms and protective clothing – non-cash | yes | no | 40 | yes |

| Utilities allowance, clergy – in cash | [Footnote7](#fn7) | yes | 40 | no |

| Utilities allowance – in cash | yes | yes | 40 | no |

| Utilities benefit, clergy – non cash | [Footnote7](#fn7) | no | 40 | [Footnote8](#fn8) |

| Utilities benefit, rent-free or low-rent – non cash | yes | no | 40 | [Footnote8](#fn8) |
...
- View and download pensionable and insurable earnings reviews (PIERs) on file

- Download reports

- Track the progress of certain files and enquires you have submitted to the CRA
...
A pre-authorized debit (PAD) is a secure online self-service payment option for individuals and businesses to pay their taxes. A PAD lets you authorize withdrawals from your Canadian chequing account to pay the CRA. You can set the payment dates and amounts of your PAD agreement using the CRA's My Business Account. PADs are flexible and managed by you. You can use My Business Account to view your account history and modify, cancel or skip a payment. For more information, go to [Pay by scheduled pre-authorized debit (PAD) through CRA online services](https://www.canada.ca/en/revenue-agency/services/about-canada-revenue-agency-cra/pay-authorized-debit.html).

## For more information

### If you need help

For help with common topics, current contact centre wait times, and links to online self-serve options, go to [Taxes](https://www.canada.ca/en/services/taxes.html).
...
- [GST/HST Memorandum 9.1, Taxable Benefits (Other than Automobile Benefits)](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/9-1.html)

- [GST/HST Memorandum 9.2, Automobile Benefits](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/9-2.html)
...
Register with Canada VRS to download the app, by going to srvcanadavrs.ca/en/get-the-app/personal-account, and call the VRS line.If you use another **operator-assisted relay service**, call the CRA’s regular telephone numbers instead of the TTY and Canada VRS numbers.
...
- You may save time by calling the CRA first depending on your situation. You can call the telephone number provided in your CRA correspondence or discuss your concerns with the employee you have been dealing with. If you do not have a contact number, go to canada.ca/cra-contact

- You can ask to discuss the matter with the employee’s supervisor if you have not been able to resolve your service issue

- You can submit feedback by filling out Form RC193, Service Feedback, if the issue remains unresolved. For more information, go to canada.ca/cra-service-feedback
...
The CRA’s discretion is limited to any period that ends within 10 calendar years before the year in which a relief request is made.

**Penalties**

The CRA will consider your request only if it relates to a tax year or fiscal period ending in any of the 10 calendar years before the year in which you make your request. For example, your request made in 2024 must relate to a penalty for a tax year or fiscal period ending in 2014 or later.

**Interest on a Balance Owing**

The CRA will consider only the amounts that accrued during the 10 calendar years before the year in which you make your request. For example, your request made in 2025 must relate to interest that accrued in 2015 or later.
...
For more details on the required supporting documents, relief from penalties and interest and other related forms and publications, go to [Cancel or waive penalties and interest at the CRA](https://www.canada.ca/en/revenue-agency/services/about-canada-revenue-agency-cra/complaints-disputes/cancel-waive-penalties-interest.html).
