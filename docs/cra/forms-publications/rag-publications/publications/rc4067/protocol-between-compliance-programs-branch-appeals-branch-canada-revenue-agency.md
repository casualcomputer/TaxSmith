---
title: "Protocol between the Appeals Branch and the Compliance Programs Branch of the Canada Revenue Agency"
...
The purpose of this protocol is to establish a referral process between the Appeals Branch (Appeals) and Compliance Programs Branch (CPB) when resolving objections filed as a result of an audit **assessment**[Footnote1](#fn1), when **audit-specified documents**[Footnote2](#fn2) or **new information**[Footnote3](#fn3) has been provided for the first time at the objection stage.
...
- Criminal Investigations Directorate – only Illicit Income Audit Program

- GST/HST and Digital Compliance Directorate – except mandatory referrals will not apply for the GST/HST Refund Integrity Program (RIP)
...
- During the course of resolving an objection, a taxpayer may provide **audit-specified documents** not submitted at the audit stage. If the appeals officer receives such documents, the appeals officer **will** request assistance from a CPB auditor to review the audit-specified documents submitted.

- Where an "Election for nil consideration" under subsection 156(2) of the Excise Tax Act is filed by the taxpayer at the objection stage (request for late-filed election).
...
- Where substantial **new information** is provided, requiring additional audit activities to be performed.

- Where the net tax was estimated, due to insufficient books and records;

- Where input tax credits were disallowed as the accounting records/documentation were not provided;

- Where an on-site visit or specialized auditing tools/software are warranted to verify certain facts provided by the taxpayer;

- Where the objection relates to an initial assessment concerning issues of prior years’ returns currently being considered by
