---
title: "LTN2 Subject vehicles under the Select Luxury Items Tax Act"
source: https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/ltn2/subject-vehicles-under-select-luxury-items-tax-act.html
...
- [Overview](#_Toc109143343)

- [Vehicles subject to the luxury tax](#_Toc109143344)

    - [Exclusions](#_Toc109143345)

- [Application of the luxury tax](#_Toc109143346)

    - [Selling subject vehicles](#_Toc109143347)

          - [Exemption on sales between registered vendors](#_Toc109143348)

          - [Exemption on sales of previously registered subject vehicles](#_Toc109143349)

          - [Exemption on sales of subject vehicles equipped for military or policing activities](#_Toc109143350)

    - [Importing subject vehicles](#_Toc109143351)

          - [Exemption on importations by registered vendors](#_Toc109143352)

          - [Exemption on importations of previously registered subject vehicles](#_Toc109143353)

          - [Exemption on importations of subject vehicles equipped for military or policing activities](#_Toc109143354)

    - [Registering subject vehicles owned by a registered vendor](#_Toc109143355)

    - [Leasing out subject vehicles](#_Toc109143356)

          - [Exemption on leases of subject vehicles equipped for military or policing activities](#_Toc109143357)

    - [Ceasing to be a registered vendor of subject vehicles](#_Toc109143358)

    - [Having improvements made to subject vehicles](#_Toc109143359)

          - [Excluded improvements](#_Toc109143360)

- [General calculation of the luxury tax (except for improvements)](#_Toc109143361)

    - [Taxable amount for sales of subject vehicles](#_Toc109143362)

    - [Taxable amount for importations of subject vehicles](#_Toc109143363)

    - [Taxable amount for registrations of subject vehicles owned by a registered vendor](#_Toc109143364)

    - [Taxable amount for leases of subject vehicles](#_Toc109143365)

    - [Taxable amount for subject vehicles held by a person ceasing to be a registered vendor](#_Toc109143366)

    - [Determining the retail value](#_Toc109143367)

- [Calculation of the luxury tax on improvements](#_Toc109143368)

- [Reporting the luxury tax and filing returns](#_Toc109143369)

    - [Reporting periods and filing/payment deadlines](#_Toc109143370)

    - [Penalties](#_Toc109143371)
...
On August 10, 2021, the Department of Finance Canada (Finance Canada) published a [background paper](https://www.canada.ca/en/department-finance/programs/consultations/2021/consultation-proposed-luxury-tax/select-luxury-goods-tax.html) on the design of the proposed luxury tax for public consultation. On March 11, 2022, Finance Canada also released [draft legislative proposals](https://fin.canada.ca/drleg-apl/2022/ita-lir-0322-eng.html) for stakeholder input. The proposed *Select Luxury Items Tax Act* was included in [Bill C-19, Budget Implementation Act, 2022, No. 1](https://www.parl.ca/legisinfo/en/bill/44-1/c-19), which received royal assent on June 23, 2022.
...
- an agent of His Majesty in right of Canada or a province
...
For more information on applying to register as a registered vendor under the Act, refer to [Notice LTN1, Registration under the Select Luxury Items Tax Act](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/ltn1/registration-under-select-luxury-items-tax-act.html).

As set out in subsection 19(1), in order to purchase subject vehicles priced above the price threshold without the luxury tax applying at the time the sale is completed, the purchasing registered vendor will need to provide an exemption certificateto the selling registered vendor in accordance with section 36. An exemption certificate is a document in which a purchaser attests to a vendor that the purchaser is eligible for an exemption from the luxury tax. To be eligible for an exemption from the luxury tax on the purchase of subject vehicles priced above the price threshold, the purchaser must be a registered vendor of subject vehicles at the time the sale is completed.

Purchasers of subject vehicles priced above the price threshold should use [Form L100-1, Luxury Tax Exemption Certificate for Subject Vehicles](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/l100-1.html), as an exemption certificate to certify that they are registered vendors of subject vehicles.
...
For more information on the application of the luxury tax to the importation of subject vehicles, visit the [Canada Border Services Agency](https://www.cbsa-asfc.gc.ca/contact/bis-sif-eng.html) webpages.
...
For more information on applying to register as a registered vendor for the purposes of the Act, refer to [Notice LTN1](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/ltn1/registration-under-select-luxury-items-tax-act.html).
...
The luxury tax could apply when improvements are made to subject vehicles, as set out in sections 29 to 32. According to subsection 8(1), an **improvement** to a subject vehicleis the provision of either:
...
For more information on calculating the taxable amount in respect of importations of subject vehicles, visit the [Canada Border Services Agency](https://www.cbsa-asfc.gc.ca/contact/bis-sif-eng.html) webpages.
...
- the retail valueof the subject vehicle at the time at which it is registered with the Government of Canada or a province
...
- the retail valueof the subject vehicle at the time at which the lessee first has the right to use the subject vehicle under the agreement
...
- the amount determined under section 34 using the **unimproved taxable amount**, which is equal to the taxable amountof the subject vehicle
...
| A | is the lesser of: the total taxable amount multiplied by 10% the amount that results from subtracting $100,000 from the total taxable amount and multiplying the difference by 20% |

| B | is the lesser of: the unimproved taxable amount multiplied by 10% the amount that results from subtracting $100,000 from the unimproved taxable amount and multiplying the difference by 20% |
