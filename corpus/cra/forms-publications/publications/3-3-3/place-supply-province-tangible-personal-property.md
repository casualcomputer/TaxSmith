---
title: "Place of Supply in a Province ‑ Tangible Personal Property"
source: https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/3-3-3/place-supply-province-tangible-personal-property.html
last_modified: 2024-08-07
---
# Place of Supply in a Province ‑ Tangible Personal Property

GST/HST Memorandum 3-3-3 April 2026
...
- [Tangible personal property supplied by way of sale](#h_2)

    - [Deemed delivery](#h_2_1)

          - [Supplier retains a common carrier on behalf of the recipient](#h_2_1_1)

    - [Delivery of tangible personal property on exercise of option](#h_2_2)

    - [Sale of a specified motor vehicle](#h_2_3)

- [Tangible personal property supplied otherwise than by way of sale](#h_3)

    - [Deemed supply](#h_3_1)

    - [Supply of property for each lease interval](#h_3_2)

    - [Supply for more than three months – specified motor vehicle](#h_3_3)

    - [Supply for more than three months – property other than specified motor vehicle](#h_3_4)

          - [Ordinary Location of Property](#h_3_4_1)

    - [Supply for three months or less](#h_3_5)

          - [Deemed delivery in a province](#h_3_5_1)

          - [Single determination of place of supply based on initial delivery](#h_3_5_2)

- [Railway rolling stock supplied otherwise than by way of sale](#h_4)

    - [Rule 1 – Supplier delivers to a recipient in a province](#h_4_1)

    - [Rule 2 – Place of supply for lease interval](#h_4_2)

    - [Rule 3 – Renewal of agreement](#h_4_3)

    - [Rule 4 – Agreements entered into before April 1, 1997](#h_4_4)

    - [Rule 5 – Agreements entered into before July 1, 2010](#h_4_5)

    - [Rule 6 – Agreements entered into before April 1, 2013](#h_4_6)

- [First Nations goods and services tax – place of supply](#h_5)

    - [Supply is deemed to be made on FNGST lands in a non-participating province](#h_5_1)

    - [Supply is deemed to be made on FNGST lands in a participating province](#h_5_2)

    - [Supply is deemed to be made in Canada, but not on FNGST lands](#h_5_3)
...
4. For further information regarding the legislative framework as well as the issues to consider before applying the provincial place of supply rules, refer to [GST/HST Memorandum 3-3-2, Provincial Place of Supply –Overview](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/3-3-2.html).
...
For further information on the application of the GST/HST to goods sold on a consignment basis, refer to [GST/HST Info Sheet GI-009, Consigned Goods](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/gi-009.html).
...
As a result, the sale of the good from the Ontario supplier to the final purchaser is made in Nova Scotia and subject to the HST at a rate of 14% because it was delivered to the purchaser in Nova Scotia by the supplier’s agent.

For further information on agency, refer to [GST/HST Info Sheet GI-012, Agents](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/gi-012.html).
...
24. For further information and an overview of the application of the provincial part of the HST to sales of specified motor vehicles, refer to [GST/HST Info Sheet GI-119, Harmonized Sales Tax – Place of Supply of Specified Motor Vehicles Delivered and Registered in a Different Province](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/gi-119.html).
...
The dealer should collect the HST at a rate of 14% in respect of the supply of the vehicle.

The recipient may later be eligible for a rebate of the 9% provincial part of the HST that the recipient paid to the dealer.
...
25. For further information regarding the application of the HST and the rebate of the provincial part of the HST referred to in examples 12 and 13, refer to [GST/HST Info Sheet GI‑119](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/gi-119.html) and [Form GST495, Rebate Application for Provincial Part of Harmonized Sales Tax (HST)](https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/gst495.html).
...
Upon registering the vehicle in Nova Scotia, the recipient is required to pay the HST to the provincial motor vehicle registration authority in Nova Scotia calculated at a rate of 1% (9% Nova Scotia provincial rate minus 8% Ontario provincial rate).
...
53. Provided the purchaser meets the criteria set out in [GST/HST Technical Information Bulletin B-039, GST/HST Administrative Policy – Application of the GST/HST to Indians](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/b-039.html), the provincial part of the HST would be relieved. Where the purchaser does not qualify for relief of the provincial part of the HST under Technical Information Bulletin B-039, registered vendors are required to collect the provincial part of the HST in participating provinces unless relief of that part is provided by some other legislation or policy.
